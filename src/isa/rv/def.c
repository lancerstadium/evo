...
#define RV_EXEC_I(...)                             \
    do {                                           \
        u8 rd = Val_as_u8(insn->oprs[0], 0);       \
        u8 r1 = Val_as_u8(insn->oprs[1], 0);       \
        u64 immi = Val_as_u64(insn->oprs[2], 0); \
        Val* r1_v = CPUState_get_reg(RV, cpu, r1); \
        Val* res = Val_new_u64(__VA_ARGS__);       \
        CPUState_set_reg(RV, cpu, rd, res);        \
        Val_free(r1_v);                            \
...
void CPUState_OP_def(RV, execute)(CPUState(RV) * cpu, Insn(RV) * insn) {
    switch(insn->id) {
        ...
        case RV_SUB     : RV_EXEC_R(Val_as_u64(r1_v, 0)  -  Val_as_u64(r2_v, 0));   break;
        case RV_XOR     : RV_EXEC_R(Val_as_u64(r1_v, 0)  ^  Val_as_u64(r2_v, 0));   break;
        case RV_OR      : RV_EXEC_R(Val_as_u64(r1_v, 0)  |  Val_as_u64(r2_v, 0));   break;
        case RV_AND     : RV_EXEC_R(Val_as_u64(r1_v, 0)  &  Val_as_u64(r2_v, 0));   break;
        case RV_SLL     : RV_EXEC_R(Val_as_u64(r1_v, 0) <<  Val_as_u64(r2_v, 0));   break;
        case RV_SRL     : RV_EXEC_R(Val_as_u64(r1_v, 0) >>  Val_as_u64(r2_v, 0));   break;
        case RV_SRA     : RV_EXEC_R(Val_as_i64(r1_v, 0) >>  Val_as_u64(r2_v, 0));   break;
        ...
        case RV_ADDI    : RV_EXEC_I(Val_as_u64(r1_v, 0)  +  immi);                  break;
        case RV_XORI    : RV_EXEC_I(Val_as_u64(r1_v, 0)  ^  immi);                  break;
        case RV_ORI     : RV_EXEC_I(Val_as_u64(r1_v, 0)  |  immi);                  break;
        case RV_ANDI    : RV_EXEC_I(Val_as_u64(r1_v, 0)  &  immi);                  break;
        case RV_SLLI    : RV_EXEC_I(Val_as_u64(r1_v, 0) <<  immi);                  break;
        case RV_SRLI    : RV_EXEC_I(Val_as_u64(r1_v, 0) >>  immi);                  break;
