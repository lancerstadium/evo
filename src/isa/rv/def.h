...
InsnDef_def(RV,
    [RV_NOP]    = { .id = RV_NOP    , .mnem = "nop"     , .bc = Val_u32(0x00) },
    /* RV32I: R-Type Arithmetic */
    [RV_ADD]    = { .id = RV_ADD    , .mnem = "add"     , .bc = Val_u32(0b0110011 + (0b000 << 12))                  , .tv = Tys_rvR()  },
    [RV_SUB]    = { .id = RV_SUB    , .mnem = "sub"     , .bc = Val_u32(0b0110011 + (0b000 << 12) + (0x20 << 25))   , .tv = Tys_rvR()  },
    [RV_XOR]    = { .id = RV_XOR    , .mnem = "xor"     , .bc = Val_u32(0b0110011 + (0b100 << 12))                  , .tv = Tys_rvR()  },
    [RV_OR]     = { .id = RV_OR     , .mnem = "or"      , .bc = Val_u32(0b0110011 + (0b110 << 12))                  , .tv = Tys_rvR()  },
    [RV_AND]    = { .id = RV_AND    , .mnem = "and"     , .bc = Val_u32(0b0110011 + (0b111 << 12))                  , .tv = Tys_rvR()  },
    [RV_SLL]    = { .id = RV_SLL    , .mnem = "sll"     , .bc = Val_u32(0b0110011 + (0b001 << 12))                  , .tv = Tys_rvR()  },
    [RV_SRL]    = { .id = RV_SRL    , .mnem = "srl"     , .bc = Val_u32(0b0110011 + (0b101 << 12))                  , .tv = Tys_rvR()  },
    [RV_SRA]    = { .id = RV_SRA    , .mnem = "sra"     , .bc = Val_u32(0b0110011 + (0b101 << 12) + (0x20 << 25))   , .tv = Tys_rvR()  },
    [RV_SLT]    = { .id = RV_SLT    , .mnem = "slt"     , .bc = Val_u32(0b0110011 + (0b010 << 12))                  , .tv = Tys_rvR()  },
    [RV_SLTU]   = { .id = RV_SLTU   , .mnem = "sltu"    , .bc = Val_u32(0b0110011 + (0b011 << 12))                  , .tv = Tys_rvR()  },
    /* RV32I: I-Type Arithmetic */ 
    [RV_ADDI]   = { .id = RV_ADDI   , .mnem = "addi"    , .bc = Val_u32(0b0010011 + (0b000 << 12))                  , .tv = Tys_rvI()  },
    [RV_XORI]   = { .id = RV_XORI   , .mnem = "xori"    , .bc = Val_u32(0b0010011 + (0b100 << 12))                  , .tv = Tys_rvI()  },
    [RV_ORI]    = { .id = RV_ORI    , .mnem = "ori"     , .bc = Val_u32(0b0010011 + (0b110 << 12))                  , .tv = Tys_rvI()  },
    [RV_ANDI]   = { .id = RV_ANDI   , .mnem = "andi"    , .bc = Val_u32(0b0010011 + (0b111 << 12))                  , .tv = Tys_rvI()  },
    [RV_SLLI]   = { .id = RV_SLLI   , .mnem = "slli"    , .bc = Val_u32(0b0010011 + (0b001 << 12))                  , .tv = Tys_rvI()  },
    [RV_SRLI]   = { .id = RV_SRLI   , .mnem = "srli"    , .bc = Val_u32(0b0010011 + (0b101 << 12))                  , .tv = Tys_rvI()  },
    [RV_SRAI]   = { .id = RV_SRAI   , .mnem = "srai"    , .bc = Val_u32(0b0010011 + (0b101 << 12) + (0x20 << 25))   , .tv = Tys_rvI()  },
    [RV_SLTI]   = { .id = RV_SLTI   , .mnem = "slti"    , .bc = Val_u32(0b0010011 + (0b010 << 12))                  , .tv = Tys_rvI()  },
    [RV_SLTIU]  = { .id = RV_SLTIU  , .mnem = "sltiu"   , .bc = Val_u32(0b0010011 + (0b011 << 12))                  , .tv = Tys_rvI()  },
    /* RV32I: U-Type Arithmetic */
    [RV_LUI]    = { .id = RV_LUI    , .mnem = "lui"     , .bc = Val_u32(0b0110111)                                  , .tv = Tys_rvU()  },
    [RV_AUIPC]  = { .id = RV_AUIPC  , .mnem = "auipc"   , .bc = Val_u32(0b0010111)                                  , .tv = Tys_rvU()  },
    /* RV32I: Load I-Type */
    [RV_LB]     = { .id = RV_LB     , .mnem = "lb"      , .bc = Val_u32(0b0000011 + (0b000 << 12))                  , .tv = Tys_rvI()  },
    [RV_LH]     = { .id = RV_LH     , .mnem = "lh"      , .bc = Val_u32(0b0000011 + (0b001 << 12))                  , .tv = Tys_rvI()  },
    [RV_LW]     = { .id = RV_LW     , .mnem = "lw"      , .bc = Val_u32(0b0000011 + (0b010 << 12))                  , .tv = Tys_rvI()  },
    [RV_LBU]    = { .id = RV_LBU    , .mnem = "lbu"     , .bc = Val_u32(0b0000011 + (0b100 << 12))                  , .tv = Tys_rvI()  },
    [RV_LHU]    = { .id = RV_LHU    , .mnem = "lhu"     , .bc = Val_u32(0b0000011 + (0b101 << 12))                  , .tv = Tys_rvI()  },
    /* RV32I: Store S-Type */
    [RV_SB]     = { .id = RV_SB     , .mnem = "sb"      , .bc = Val_u32(0b0100011 + (0b000 << 12))                  , .tv = Tys_rvS()  },
    [RV_SH]     = { .id = RV_SH     , .mnem = "sh"      , .bc = Val_u32(0b0100011 + (0b001 << 12))                  , .tv = Tys_rvS()  },
    [RV_SW]     = { .id = RV_SW     , .mnem = "sw"      , .bc = Val_u32(0b0100011 + (0b010 << 12))                  , .tv = Tys_rvS()  },
    /* RV32I: Branch B-Type */
    [RV_BEQ]    = { .id = RV_BEQ    , .mnem = "beq"     , .bc = Val_u32(0b1100011 + (0b000 << 12))                  , .tv = Tys_rvB()  },
    [RV_BNE]    = { .id = RV_BNE    , .mnem = "bne"     , .bc = Val_u32(0b1100011 + (0b001 << 12))                  , .tv = Tys_rvB()  },
    [RV_BLT]    = { .id = RV_BLT    , .mnem = "blt"     , .bc = Val_u32(0b1100011 + (0b100 << 12))                  , .tv = Tys_rvB()  },
    [RV_BGE]    = { .id = RV_BGE    , .mnem = "bge"     , .bc = Val_u32(0b1100011 + (0b101 << 12))                  , .tv = Tys_rvB()  },
    [RV_BLTU]   = { .id = RV_BLTU   , .mnem = "bltu"    , .bc = Val_u32(0b1100011 + (0b110 << 12))                  , .tv = Tys_rvB()  },
    [RV_BGEU]   = { .id = RV_BGEU   , .mnem = "bgeu"    , .bc = Val_u32(0b1100011 + (0b111 << 12))                  , .tv = Tys_rvB()  },
    /* RV32I: Jump J-Type */
    [RV_JALR]   = { .id = RV_JALR   , .mnem = "jalr"    , .bc = Val_u32(0b1100111 + (0b000 << 12))                  , .tv = Tys_rvI()  },
    [RV_JAL]    = { .id = RV_JAL    , .mnem = "jal"     , .bc = Val_u32(0b1101111)                                  , .tv = Tys_rvJ()  },
    /* RV32I: Device & System */
    [RV_ECALL]  = { .id = RV_ECALL  , .mnem = "ecall"   , .bc = Val_u32(0b1110011 + (0b000 << 12) + (0x00 << 20))   , .tv = Tys_rvIe() },
    [RV_EBREAK] = { .id = RV_EBREAK , .mnem = "ebreak"  , .bc = Val_u32(0b1110011 + (0b000 << 12) + (0x01 << 20))   , .tv = Tys_rvIe() },
);
