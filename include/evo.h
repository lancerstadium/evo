...
EVO_API void graph_add_linear(graph_t*, int, const char*);
EVO_API void graph_add_activation(graph_t*, const char*);
EVO_API void graph_add_conv2d(graph_t*, int64_t[2], int64_t[2], int64_t[4], int64_t[2], int, char*);
EVO_API void graph_add_maxpool2d(graph_t*, int64_t[2], int64_t[2], int64_t[4], int64_t[2], int, int);
