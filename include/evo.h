...
struct tensor {
    ...
    uint8_t is_scalar   : 1;                            /* Tensor is scaler             */
};
...
EVO_API tensor_t * tensor_resize(tensor_t*, int, int, char*);
EVO_API tensor_t * tensor_cast(tensor_t*, tensor_type_t);
EVO_API tensor_t * tensor_hist(tensor_t*, float, float, int);
EVO_API tensor_t * tensor_quant(tensor_t*, tensor_t*, tensor_t*, int, tensor_type_t);
EVO_API tensor_t * tensor_dequant(tensor_t*, tensor_t*, tensor_t*, int);
...
EVO_API void tensor_fill_zero(tensor_t*);
EVO_API void tensor_fill_uniform(tensor_t*, float, float);
EVO_API void tensor_fill_normal(tensor_t*, float, float);
EVO_API void tensor_fill_xavier(tensor_t *, int, int);
EVO_API void tensor_fill_he(tensor_t *, int);
EVO_API void tensor_fill_lecun(tensor_t *, int);
...
EVO_API void tensor_boardcast(tensor_t*,tensor_t*);
...
EVO_API void attribute_dump3(attribute_t*);
...
EVO_API int node_get_nmemory(node_t*);
...
EVO_API void node_dump3(node_t*);
...
EVO_API void graph_add_input(graph_t*, int, int*, tensor_type_t);
...
EVO_API void graph_dump1(graph_t*);
EVO_API void graph_dump2(graph_t*);
EVO_API void graph_dump3(graph_t*);
...
typedef mem_blob_t** mem_blob_vec_t;
...
EVO_API mem_blob_t* mem_blob_new(char* name);
EVO_API void mem_blob_apply(mem_blob_t* mb, int64_t size, int64_t lower, int64_t upper, int64_t offset);
EVO_API int64_t mem_blob_area(mem_blob_t mb);
EVO_API bool mem_blob_equal(mem_blob_t mb1, mem_blob_t mb2);
EVO_API void mem_blob_free(mem_blob_t* mb);

// ==================================================================================== //
//                                  mem: arena
// ==================================================================================== //

typedef enum mem_arena_type {
    MEM_ARENA_TYPE_FREE,
    MEM_ARENA_TYPE_NAIVE,                               /* Naive Tensor Alloc           */
    MEM_ARENA_TYPE_LSTF,                                /* Large Size Tensor First      */
...
struct mem_arena {
    char* name;
    mem_arena_type_t type;
    int64_t capacity;
    mem_blob_vec_t blobs;
};

EVO_API mem_arena_t* mem_arena_new(char* name);
EVO_API void mem_arena_push(mem_arena_t* ma, mem_blob_t* mb);
EVO_API void mem_arena_dump(mem_arena_t* ma);
EVO_API void mem_arena_solve(mem_arena_t* ma, mem_arena_type_t);
EVO_API void mem_arena_free(mem_arena_t* ma);
EVO_API mem_arena_t* mem_arena_from_graph(graph_t* g);
EVO_API void mem_arena_save_svg(mem_arena_t* ma, const char* path, float ratio);
...
EVO_API void image_save_channel(image_t*, const char*, int);
...
EVO_API void image_crop(image_t*, int, int, int, int);
...
EVO_API void image_halftone_ostromoukhov(image_t*);
...
EVO_API void figure_axis_set_label(figure_axis_t*, char*);
EVO_API void figure_axis_free(figure_axis_t*);
EVO_API figure_plot_t* figure_plot_new(char*, figure_plot_type_t, float*, size_t, size_t);
EVO_API int figure_plot_number(figure_plot_t*);
EVO_API int figure_plot_naxis(figure_plot_t*);
...
EVO_API figure_t* figure_new_2d(char*, figure_type_t, figure_plot_type_t, tensor_t*);
EVO_API void figure_add_plot_1d(figure_t*, figure_plot_type_t, tensor_t*, int);
EVO_API void figure_add_plot_2d(figure_t*, figure_plot_type_t, tensor_t*, int);
