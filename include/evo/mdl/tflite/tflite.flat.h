...
typedef const struct tflite_Conv3DOptions_table *tflite_Conv3DOptions_table_t;
typedef struct tflite_Conv3DOptions_table *tflite_Conv3DOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_Conv3DOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_Conv3DOptions_mutable_vec_t;
...
typedef const struct tflite_CallOnceOptions_table *tflite_CallOnceOptions_table_t;
typedef struct tflite_CallOnceOptions_table *tflite_CallOnceOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_CallOnceOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_CallOnceOptions_mutable_vec_t;
...
typedef const struct tflite_BatchMatMulOptions_table *tflite_BatchMatMulOptions_table_t;
typedef struct tflite_BatchMatMulOptions_table *tflite_BatchMatMulOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_BatchMatMulOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_BatchMatMulOptions_mutable_vec_t;
typedef const struct tflite_CumsumOptions_table *tflite_CumsumOptions_table_t;
typedef struct tflite_CumsumOptions_table *tflite_CumsumOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_CumsumOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_CumsumOptions_mutable_vec_t;
typedef const struct tflite_BroadcastToOptions_table *tflite_BroadcastToOptions_table_t;
typedef struct tflite_BroadcastToOptions_table *tflite_BroadcastToOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_BroadcastToOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_BroadcastToOptions_mutable_vec_t;
typedef const struct tflite_Rfft2dOptions_table *tflite_Rfft2dOptions_table_t;
typedef struct tflite_Rfft2dOptions_table *tflite_Rfft2dOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_Rfft2dOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_Rfft2dOptions_mutable_vec_t;
typedef const struct tflite_HashtableOptions_table *tflite_HashtableOptions_table_t;
typedef struct tflite_HashtableOptions_table *tflite_HashtableOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_HashtableOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_HashtableOptions_mutable_vec_t;
typedef const struct tflite_HashtableFindOptions_table *tflite_HashtableFindOptions_table_t;
typedef struct tflite_HashtableFindOptions_table *tflite_HashtableFindOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_HashtableFindOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_HashtableFindOptions_mutable_vec_t;
typedef const struct tflite_HashtableImportOptions_table *tflite_HashtableImportOptions_table_t;
typedef struct tflite_HashtableImportOptions_table *tflite_HashtableImportOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_HashtableImportOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_HashtableImportOptions_mutable_vec_t;
typedef const struct tflite_HashtableSizeOptions_table *tflite_HashtableSizeOptions_table_t;
typedef struct tflite_HashtableSizeOptions_table *tflite_HashtableSizeOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_HashtableSizeOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_HashtableSizeOptions_mutable_vec_t;
typedef const struct tflite_VarHandleOptions_table *tflite_VarHandleOptions_table_t;
typedef struct tflite_VarHandleOptions_table *tflite_VarHandleOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_VarHandleOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_VarHandleOptions_mutable_vec_t;
typedef const struct tflite_ReadVariableOptions_table *tflite_ReadVariableOptions_table_t;
typedef struct tflite_ReadVariableOptions_table *tflite_ReadVariableOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_ReadVariableOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_ReadVariableOptions_mutable_vec_t;
typedef const struct tflite_AssignVariableOptions_table *tflite_AssignVariableOptions_table_t;
typedef struct tflite_AssignVariableOptions_table *tflite_AssignVariableOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_AssignVariableOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_AssignVariableOptions_mutable_vec_t;
typedef const struct tflite_RandomOptions_table *tflite_RandomOptions_table_t;
typedef struct tflite_RandomOptions_table *tflite_RandomOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_RandomOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_RandomOptions_mutable_vec_t;
typedef const struct tflite_BucketizeOptions_table *tflite_BucketizeOptions_table_t;
typedef struct tflite_BucketizeOptions_table *tflite_BucketizeOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_BucketizeOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_BucketizeOptions_mutable_vec_t;
typedef const struct tflite_GeluOptions_table *tflite_GeluOptions_table_t;
typedef struct tflite_GeluOptions_table *tflite_GeluOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_GeluOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_GeluOptions_mutable_vec_t;
typedef const struct tflite_DynamicUpdateSliceOptions_table *tflite_DynamicUpdateSliceOptions_table_t;
typedef struct tflite_DynamicUpdateSliceOptions_table *tflite_DynamicUpdateSliceOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_DynamicUpdateSliceOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_DynamicUpdateSliceOptions_mutable_vec_t;
typedef const struct tflite_UnsortedSegmentProdOptions_table *tflite_UnsortedSegmentProdOptions_table_t;
typedef struct tflite_UnsortedSegmentProdOptions_table *tflite_UnsortedSegmentProdOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_UnsortedSegmentProdOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_UnsortedSegmentProdOptions_mutable_vec_t;
typedef const struct tflite_UnsortedSegmentMaxOptions_table *tflite_UnsortedSegmentMaxOptions_table_t;
typedef struct tflite_UnsortedSegmentMaxOptions_table *tflite_UnsortedSegmentMaxOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_UnsortedSegmentMaxOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_UnsortedSegmentMaxOptions_mutable_vec_t;
typedef const struct tflite_UnsortedSegmentSumOptions_table *tflite_UnsortedSegmentSumOptions_table_t;
typedef struct tflite_UnsortedSegmentSumOptions_table *tflite_UnsortedSegmentSumOptions_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_UnsortedSegmentSumOptions_vec_t;
typedef flatbuffers_uoffset_t *tflite_UnsortedSegmentSumOptions_mutable_vec_t;
typedef const struct tflite_ATan2Options_table *tflite_ATan2Options_table_t;
typedef struct tflite_ATan2Options_table *tflite_ATan2Options_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_ATan2Options_vec_t;
typedef flatbuffers_uoffset_t *tflite_ATan2Options_mutable_vec_t;
...
typedef const struct tflite_TensorMap_table *tflite_TensorMap_table_t;
typedef struct tflite_TensorMap_table *tflite_TensorMap_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_TensorMap_vec_t;
typedef flatbuffers_uoffset_t *tflite_TensorMap_mutable_vec_t;
typedef const struct tflite_SignatureDef_table *tflite_SignatureDef_table_t;
typedef struct tflite_SignatureDef_table *tflite_SignatureDef_mutable_table_t;
typedef const flatbuffers_uoffset_t *tflite_SignatureDef_vec_t;
typedef flatbuffers_uoffset_t *tflite_SignatureDef_mutable_vec_t;
...
#endif
#ifndef tflite_Conv3DOptions_file_identifier
#define tflite_Conv3DOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_Conv3DOptions_file_identifier */
#ifndef tflite_Conv3DOptions_identifier
#define tflite_Conv3DOptions_identifier "TFL3"
#endif
#define tflite_Conv3DOptions_type_hash ((flatbuffers_thash_t)0xc06a6c58)
#define tflite_Conv3DOptions_type_identifier "\x58\x6c\x6a\xc0"
#ifndef tflite_Conv3DOptions_file_extension
#define tflite_Conv3DOptions_file_extension "tflite"
#endif
...
#endif
#ifndef tflite_CallOnceOptions_file_identifier
#define tflite_CallOnceOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_CallOnceOptions_file_identifier */
#ifndef tflite_CallOnceOptions_identifier
#define tflite_CallOnceOptions_identifier "TFL3"
#endif
#define tflite_CallOnceOptions_type_hash ((flatbuffers_thash_t)0x17687a54)
#define tflite_CallOnceOptions_type_identifier "\x54\x7a\x68\x17"
#ifndef tflite_CallOnceOptions_file_extension
#define tflite_CallOnceOptions_file_extension "tflite"
#endif
...
#endif
#ifndef tflite_BatchMatMulOptions_file_identifier
#define tflite_BatchMatMulOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_BatchMatMulOptions_file_identifier */
#ifndef tflite_BatchMatMulOptions_identifier
#define tflite_BatchMatMulOptions_identifier "TFL3"
#endif
#define tflite_BatchMatMulOptions_type_hash ((flatbuffers_thash_t)0x1b49f55d)
#define tflite_BatchMatMulOptions_type_identifier "\x5d\xf5\x49\x1b"
#ifndef tflite_BatchMatMulOptions_file_extension
#define tflite_BatchMatMulOptions_file_extension "tflite"
#endif
#ifndef tflite_CumsumOptions_file_identifier
#define tflite_CumsumOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_CumsumOptions_file_identifier */
#ifndef tflite_CumsumOptions_identifier
#define tflite_CumsumOptions_identifier "TFL3"
#endif
#define tflite_CumsumOptions_type_hash ((flatbuffers_thash_t)0x3e657ca5)
#define tflite_CumsumOptions_type_identifier "\xa5\x7c\x65\x3e"
#ifndef tflite_CumsumOptions_file_extension
#define tflite_CumsumOptions_file_extension "tflite"
#endif
#ifndef tflite_BroadcastToOptions_file_identifier
#define tflite_BroadcastToOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_BroadcastToOptions_file_identifier */
#ifndef tflite_BroadcastToOptions_identifier
#define tflite_BroadcastToOptions_identifier "TFL3"
#endif
#define tflite_BroadcastToOptions_type_hash ((flatbuffers_thash_t)0xea84cfa7)
#define tflite_BroadcastToOptions_type_identifier "\xa7\xcf\x84\xea"
#ifndef tflite_BroadcastToOptions_file_extension
#define tflite_BroadcastToOptions_file_extension "tflite"
#endif
#ifndef tflite_Rfft2dOptions_file_identifier
#define tflite_Rfft2dOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_Rfft2dOptions_file_identifier */
#ifndef tflite_Rfft2dOptions_identifier
#define tflite_Rfft2dOptions_identifier "TFL3"
#endif
#define tflite_Rfft2dOptions_type_hash ((flatbuffers_thash_t)0xaf660363)
#define tflite_Rfft2dOptions_type_identifier "\x63\x03\x66\xaf"
#ifndef tflite_Rfft2dOptions_file_extension
#define tflite_Rfft2dOptions_file_extension "tflite"
#endif
#ifndef tflite_HashtableOptions_file_identifier
#define tflite_HashtableOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_HashtableOptions_file_identifier */
#ifndef tflite_HashtableOptions_identifier
#define tflite_HashtableOptions_identifier "TFL3"
#endif
#define tflite_HashtableOptions_type_hash ((flatbuffers_thash_t)0xc376a569)
#define tflite_HashtableOptions_type_identifier "\x69\xa5\x76\xc3"
#ifndef tflite_HashtableOptions_file_extension
#define tflite_HashtableOptions_file_extension "tflite"
#endif
#ifndef tflite_HashtableFindOptions_file_identifier
#define tflite_HashtableFindOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_HashtableFindOptions_file_identifier */
#ifndef tflite_HashtableFindOptions_identifier
#define tflite_HashtableFindOptions_identifier "TFL3"
#endif
#define tflite_HashtableFindOptions_type_hash ((flatbuffers_thash_t)0xa21ca590)
#define tflite_HashtableFindOptions_type_identifier "\x90\xa5\x1c\xa2"
#ifndef tflite_HashtableFindOptions_file_extension
#define tflite_HashtableFindOptions_file_extension "tflite"
#endif
#ifndef tflite_HashtableImportOptions_file_identifier
#define tflite_HashtableImportOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_HashtableImportOptions_file_identifier */
#ifndef tflite_HashtableImportOptions_identifier
#define tflite_HashtableImportOptions_identifier "TFL3"
#endif
#define tflite_HashtableImportOptions_type_hash ((flatbuffers_thash_t)0x93f65836)
#define tflite_HashtableImportOptions_type_identifier "\x36\x58\xf6\x93"
#ifndef tflite_HashtableImportOptions_file_extension
#define tflite_HashtableImportOptions_file_extension "tflite"
#endif
#ifndef tflite_HashtableSizeOptions_file_identifier
#define tflite_HashtableSizeOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_HashtableSizeOptions_file_identifier */
#ifndef tflite_HashtableSizeOptions_identifier
#define tflite_HashtableSizeOptions_identifier "TFL3"
#endif
#define tflite_HashtableSizeOptions_type_hash ((flatbuffers_thash_t)0xffd267de)
#define tflite_HashtableSizeOptions_type_identifier "\xde\x67\xd2\xff"
#ifndef tflite_HashtableSizeOptions_file_extension
#define tflite_HashtableSizeOptions_file_extension "tflite"
#endif
#ifndef tflite_VarHandleOptions_file_identifier
#define tflite_VarHandleOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_VarHandleOptions_file_identifier */
#ifndef tflite_VarHandleOptions_identifier
#define tflite_VarHandleOptions_identifier "TFL3"
#endif
#define tflite_VarHandleOptions_type_hash ((flatbuffers_thash_t)0xe4d7f6f4)
#define tflite_VarHandleOptions_type_identifier "\xf4\xf6\xd7\xe4"
#ifndef tflite_VarHandleOptions_file_extension
#define tflite_VarHandleOptions_file_extension "tflite"
#endif
#ifndef tflite_ReadVariableOptions_file_identifier
#define tflite_ReadVariableOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_ReadVariableOptions_file_identifier */
#ifndef tflite_ReadVariableOptions_identifier
#define tflite_ReadVariableOptions_identifier "TFL3"
#endif
#define tflite_ReadVariableOptions_type_hash ((flatbuffers_thash_t)0x54b54b7b)
#define tflite_ReadVariableOptions_type_identifier "\x7b\x4b\xb5\x54"
#ifndef tflite_ReadVariableOptions_file_extension
#define tflite_ReadVariableOptions_file_extension "tflite"
#endif
#ifndef tflite_AssignVariableOptions_file_identifier
#define tflite_AssignVariableOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_AssignVariableOptions_file_identifier */
#ifndef tflite_AssignVariableOptions_identifier
#define tflite_AssignVariableOptions_identifier "TFL3"
#endif
#define tflite_AssignVariableOptions_type_hash ((flatbuffers_thash_t)0xf1da9fdc)
#define tflite_AssignVariableOptions_type_identifier "\xdc\x9f\xda\xf1"
#ifndef tflite_AssignVariableOptions_file_extension
#define tflite_AssignVariableOptions_file_extension "tflite"
#endif
#ifndef tflite_RandomOptions_file_identifier
#define tflite_RandomOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_RandomOptions_file_identifier */
#ifndef tflite_RandomOptions_identifier
#define tflite_RandomOptions_identifier "TFL3"
#endif
#define tflite_RandomOptions_type_hash ((flatbuffers_thash_t)0x9ffdfe5e)
#define tflite_RandomOptions_type_identifier "\x5e\xfe\xfd\x9f"
#ifndef tflite_RandomOptions_file_extension
#define tflite_RandomOptions_file_extension "tflite"
#endif
#ifndef tflite_BucketizeOptions_file_identifier
#define tflite_BucketizeOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_BucketizeOptions_file_identifier */
#ifndef tflite_BucketizeOptions_identifier
#define tflite_BucketizeOptions_identifier "TFL3"
#endif
#define tflite_BucketizeOptions_type_hash ((flatbuffers_thash_t)0x989a8a35)
#define tflite_BucketizeOptions_type_identifier "\x35\x8a\x9a\x98"
#ifndef tflite_BucketizeOptions_file_extension
#define tflite_BucketizeOptions_file_extension "tflite"
#endif
#ifndef tflite_GeluOptions_file_identifier
#define tflite_GeluOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_GeluOptions_file_identifier */
#ifndef tflite_GeluOptions_identifier
#define tflite_GeluOptions_identifier "TFL3"
#endif
#define tflite_GeluOptions_type_hash ((flatbuffers_thash_t)0x34d5192)
#define tflite_GeluOptions_type_identifier "\x92\x51\x4d\x03"
#ifndef tflite_GeluOptions_file_extension
#define tflite_GeluOptions_file_extension "tflite"
#endif
#ifndef tflite_DynamicUpdateSliceOptions_file_identifier
#define tflite_DynamicUpdateSliceOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_DynamicUpdateSliceOptions_file_identifier */
#ifndef tflite_DynamicUpdateSliceOptions_identifier
#define tflite_DynamicUpdateSliceOptions_identifier "TFL3"
#endif
#define tflite_DynamicUpdateSliceOptions_type_hash ((flatbuffers_thash_t)0x5f7b4769)
#define tflite_DynamicUpdateSliceOptions_type_identifier "\x69\x47\x7b\x5f"
#ifndef tflite_DynamicUpdateSliceOptions_file_extension
#define tflite_DynamicUpdateSliceOptions_file_extension "tflite"
#endif
#ifndef tflite_UnsortedSegmentProdOptions_file_identifier
#define tflite_UnsortedSegmentProdOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_UnsortedSegmentProdOptions_file_identifier */
#ifndef tflite_UnsortedSegmentProdOptions_identifier
#define tflite_UnsortedSegmentProdOptions_identifier "TFL3"
#endif
#define tflite_UnsortedSegmentProdOptions_type_hash ((flatbuffers_thash_t)0x2591cee7)
#define tflite_UnsortedSegmentProdOptions_type_identifier "\xe7\xce\x91\x25"
#ifndef tflite_UnsortedSegmentProdOptions_file_extension
#define tflite_UnsortedSegmentProdOptions_file_extension "tflite"
#endif
#ifndef tflite_UnsortedSegmentMaxOptions_file_identifier
#define tflite_UnsortedSegmentMaxOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_UnsortedSegmentMaxOptions_file_identifier */
#ifndef tflite_UnsortedSegmentMaxOptions_identifier
#define tflite_UnsortedSegmentMaxOptions_identifier "TFL3"
#endif
#define tflite_UnsortedSegmentMaxOptions_type_hash ((flatbuffers_thash_t)0xe5320d9e)
#define tflite_UnsortedSegmentMaxOptions_type_identifier "\x9e\x0d\x32\xe5"
#ifndef tflite_UnsortedSegmentMaxOptions_file_extension
#define tflite_UnsortedSegmentMaxOptions_file_extension "tflite"
#endif
#ifndef tflite_UnsortedSegmentSumOptions_file_identifier
#define tflite_UnsortedSegmentSumOptions_file_identifier "TFL3"
#endif
/* deprecated, use tflite_UnsortedSegmentSumOptions_file_identifier */
#ifndef tflite_UnsortedSegmentSumOptions_identifier
#define tflite_UnsortedSegmentSumOptions_identifier "TFL3"
#endif
#define tflite_UnsortedSegmentSumOptions_type_hash ((flatbuffers_thash_t)0x150afa49)
#define tflite_UnsortedSegmentSumOptions_type_identifier "\x49\xfa\x0a\x15"
#ifndef tflite_UnsortedSegmentSumOptions_file_extension
#define tflite_UnsortedSegmentSumOptions_file_extension "tflite"
#endif
#ifndef tflite_ATan2Options_file_identifier
#define tflite_ATan2Options_file_identifier "TFL3"
#endif
/* deprecated, use tflite_ATan2Options_file_identifier */
#ifndef tflite_ATan2Options_identifier
#define tflite_ATan2Options_identifier "TFL3"
#endif
#define tflite_ATan2Options_type_hash ((flatbuffers_thash_t)0x3e0409ed)
#define tflite_ATan2Options_type_identifier "\xed\x09\x04\x3e"
#ifndef tflite_ATan2Options_file_extension
#define tflite_ATan2Options_file_extension "tflite"
#endif
...
#endif
#ifndef tflite_TensorMap_file_identifier
#define tflite_TensorMap_file_identifier "TFL3"
#endif
/* deprecated, use tflite_TensorMap_file_identifier */
#ifndef tflite_TensorMap_identifier
#define tflite_TensorMap_identifier "TFL3"
#endif
#define tflite_TensorMap_type_hash ((flatbuffers_thash_t)0x9aa30690)
#define tflite_TensorMap_type_identifier "\x90\x06\xa3\x9a"
#ifndef tflite_TensorMap_file_extension
#define tflite_TensorMap_file_extension "tflite"
#endif
#ifndef tflite_SignatureDef_file_identifier
#define tflite_SignatureDef_file_identifier "TFL3"
#endif
/* deprecated, use tflite_SignatureDef_file_identifier */
#ifndef tflite_SignatureDef_identifier
#define tflite_SignatureDef_identifier "TFL3"
#endif
#define tflite_SignatureDef_type_hash ((flatbuffers_thash_t)0x636a1fe2)
#define tflite_SignatureDef_type_identifier "\xe2\x1f\x6a\x63"
#ifndef tflite_SignatureDef_file_extension
#define tflite_SignatureDef_file_extension "tflite"
#endif
...
#define tflite_TensorType_FLOAT64 ((tflite_TensorType_enum_t)INT8_C(10))
#define tflite_TensorType_COMPLEX128 ((tflite_TensorType_enum_t)INT8_C(11))
#define tflite_TensorType_UINT64 ((tflite_TensorType_enum_t)INT8_C(12))
#define tflite_TensorType_RESOURCE ((tflite_TensorType_enum_t)INT8_C(13))
#define tflite_TensorType_VARIANT ((tflite_TensorType_enum_t)INT8_C(14))
#define tflite_TensorType_UINT32 ((tflite_TensorType_enum_t)INT8_C(15))
#define tflite_TensorType_UINT16 ((tflite_TensorType_enum_t)INT8_C(16))
...
static inline const char *tflite_TensorType_name(tflite_TensorType_enum_t value)
{
    ...
    case tflite_TensorType_FLOAT64: return "FLOAT64";
    case tflite_TensorType_COMPLEX128: return "COMPLEX128";
    case tflite_TensorType_UINT64: return "UINT64";
    case tflite_TensorType_RESOURCE: return "RESOURCE";
    case tflite_TensorType_VARIANT: return "VARIANT";
    case tflite_TensorType_UINT32: return "UINT32";
    case tflite_TensorType_UINT16: return "UINT16";
    default: return "";
    }
}
...
static inline int tflite_TensorType_is_known_value(tflite_TensorType_enum_t value)
{
    ...
    case tflite_TensorType_FLOAT64: return 1;
    case tflite_TensorType_COMPLEX128: return 1;
    case tflite_TensorType_UINT64: return 1;
    case tflite_TensorType_RESOURCE: return 1;
    case tflite_TensorType_VARIANT: return 1;
    case tflite_TensorType_UINT32: return 1;
    case tflite_TensorType_UINT16: return 1;
    default: return 0;
    }
}
...
typedef int32_t tflite_BuiltinOperator_enum_t;
__flatbuffers_define_integer_type(tflite_BuiltinOperator, tflite_BuiltinOperator_enum_t, 32)
#define tflite_BuiltinOperator_ADD ((tflite_BuiltinOperator_enum_t)INT32_C(0))
#define tflite_BuiltinOperator_AVERAGE_POOL_2D ((tflite_BuiltinOperator_enum_t)INT32_C(1))
#define tflite_BuiltinOperator_CONCATENATION ((tflite_BuiltinOperator_enum_t)INT32_C(2))
#define tflite_BuiltinOperator_CONV_2D ((tflite_BuiltinOperator_enum_t)INT32_C(3))
#define tflite_BuiltinOperator_DEPTHWISE_CONV_2D ((tflite_BuiltinOperator_enum_t)INT32_C(4))
#define tflite_BuiltinOperator_DEPTH_TO_SPACE ((tflite_BuiltinOperator_enum_t)INT32_C(5))
#define tflite_BuiltinOperator_DEQUANTIZE ((tflite_BuiltinOperator_enum_t)INT32_C(6))
#define tflite_BuiltinOperator_EMBEDDING_LOOKUP ((tflite_BuiltinOperator_enum_t)INT32_C(7))
#define tflite_BuiltinOperator_FLOOR ((tflite_BuiltinOperator_enum_t)INT32_C(8))
#define tflite_BuiltinOperator_FULLY_CONNECTED ((tflite_BuiltinOperator_enum_t)INT32_C(9))
#define tflite_BuiltinOperator_HASHTABLE_LOOKUP ((tflite_BuiltinOperator_enum_t)INT32_C(10))
#define tflite_BuiltinOperator_L2_NORMALIZATION ((tflite_BuiltinOperator_enum_t)INT32_C(11))
#define tflite_BuiltinOperator_L2_POOL_2D ((tflite_BuiltinOperator_enum_t)INT32_C(12))
#define tflite_BuiltinOperator_LOCAL_RESPONSE_NORMALIZATION ((tflite_BuiltinOperator_enum_t)INT32_C(13))
#define tflite_BuiltinOperator_LOGISTIC ((tflite_BuiltinOperator_enum_t)INT32_C(14))
#define tflite_BuiltinOperator_LSH_PROJECTION ((tflite_BuiltinOperator_enum_t)INT32_C(15))
#define tflite_BuiltinOperator_LSTM ((tflite_BuiltinOperator_enum_t)INT32_C(16))
#define tflite_BuiltinOperator_MAX_POOL_2D ((tflite_BuiltinOperator_enum_t)INT32_C(17))
#define tflite_BuiltinOperator_MUL ((tflite_BuiltinOperator_enum_t)INT32_C(18))
#define tflite_BuiltinOperator_RELU ((tflite_BuiltinOperator_enum_t)INT32_C(19))
#define tflite_BuiltinOperator_RELU_N1_TO_1 ((tflite_BuiltinOperator_enum_t)INT32_C(20))
#define tflite_BuiltinOperator_RELU6 ((tflite_BuiltinOperator_enum_t)INT32_C(21))
#define tflite_BuiltinOperator_RESHAPE ((tflite_BuiltinOperator_enum_t)INT32_C(22))
#define tflite_BuiltinOperator_RESIZE_BILINEAR ((tflite_BuiltinOperator_enum_t)INT32_C(23))
#define tflite_BuiltinOperator_RNN ((tflite_BuiltinOperator_enum_t)INT32_C(24))
#define tflite_BuiltinOperator_SOFTMAX ((tflite_BuiltinOperator_enum_t)INT32_C(25))
#define tflite_BuiltinOperator_SPACE_TO_DEPTH ((tflite_BuiltinOperator_enum_t)INT32_C(26))
#define tflite_BuiltinOperator_SVDF ((tflite_BuiltinOperator_enum_t)INT32_C(27))
#define tflite_BuiltinOperator_TANH ((tflite_BuiltinOperator_enum_t)INT32_C(28))
#define tflite_BuiltinOperator_CONCAT_EMBEDDINGS ((tflite_BuiltinOperator_enum_t)INT32_C(29))
#define tflite_BuiltinOperator_SKIP_GRAM ((tflite_BuiltinOperator_enum_t)INT32_C(30))
#define tflite_BuiltinOperator_CALL ((tflite_BuiltinOperator_enum_t)INT32_C(31))
#define tflite_BuiltinOperator_CUSTOM ((tflite_BuiltinOperator_enum_t)INT32_C(32))
#define tflite_BuiltinOperator_EMBEDDING_LOOKUP_SPARSE ((tflite_BuiltinOperator_enum_t)INT32_C(33))
#define tflite_BuiltinOperator_PAD ((tflite_BuiltinOperator_enum_t)INT32_C(34))
#define tflite_BuiltinOperator_UNIDIRECTIONAL_SEQUENCE_RNN ((tflite_BuiltinOperator_enum_t)INT32_C(35))
#define tflite_BuiltinOperator_GATHER ((tflite_BuiltinOperator_enum_t)INT32_C(36))
#define tflite_BuiltinOperator_BATCH_TO_SPACE_ND ((tflite_BuiltinOperator_enum_t)INT32_C(37))
#define tflite_BuiltinOperator_SPACE_TO_BATCH_ND ((tflite_BuiltinOperator_enum_t)INT32_C(38))
#define tflite_BuiltinOperator_TRANSPOSE ((tflite_BuiltinOperator_enum_t)INT32_C(39))
#define tflite_BuiltinOperator_MEAN ((tflite_BuiltinOperator_enum_t)INT32_C(40))
#define tflite_BuiltinOperator_SUB ((tflite_BuiltinOperator_enum_t)INT32_C(41))
#define tflite_BuiltinOperator_DIV ((tflite_BuiltinOperator_enum_t)INT32_C(42))
#define tflite_BuiltinOperator_SQUEEZE ((tflite_BuiltinOperator_enum_t)INT32_C(43))
#define tflite_BuiltinOperator_UNIDIRECTIONAL_SEQUENCE_LSTM ((tflite_BuiltinOperator_enum_t)INT32_C(44))
#define tflite_BuiltinOperator_STRIDED_SLICE ((tflite_BuiltinOperator_enum_t)INT32_C(45))
#define tflite_BuiltinOperator_BIDIRECTIONAL_SEQUENCE_RNN ((tflite_BuiltinOperator_enum_t)INT32_C(46))
#define tflite_BuiltinOperator_EXP ((tflite_BuiltinOperator_enum_t)INT32_C(47))
#define tflite_BuiltinOperator_TOPK_V2 ((tflite_BuiltinOperator_enum_t)INT32_C(48))
#define tflite_BuiltinOperator_SPLIT ((tflite_BuiltinOperator_enum_t)INT32_C(49))
#define tflite_BuiltinOperator_LOG_SOFTMAX ((tflite_BuiltinOperator_enum_t)INT32_C(50))
#define tflite_BuiltinOperator_DELEGATE ((tflite_BuiltinOperator_enum_t)INT32_C(51))
#define tflite_BuiltinOperator_BIDIRECTIONAL_SEQUENCE_LSTM ((tflite_BuiltinOperator_enum_t)INT32_C(52))
#define tflite_BuiltinOperator_CAST ((tflite_BuiltinOperator_enum_t)INT32_C(53))
#define tflite_BuiltinOperator_PRELU ((tflite_BuiltinOperator_enum_t)INT32_C(54))
#define tflite_BuiltinOperator_MAXIMUM ((tflite_BuiltinOperator_enum_t)INT32_C(55))
#define tflite_BuiltinOperator_ARG_MAX ((tflite_BuiltinOperator_enum_t)INT32_C(56))
#define tflite_BuiltinOperator_MINIMUM ((tflite_BuiltinOperator_enum_t)INT32_C(57))
#define tflite_BuiltinOperator_LESS ((tflite_BuiltinOperator_enum_t)INT32_C(58))
#define tflite_BuiltinOperator_NEG ((tflite_BuiltinOperator_enum_t)INT32_C(59))
#define tflite_BuiltinOperator_PADV2 ((tflite_BuiltinOperator_enum_t)INT32_C(60))
#define tflite_BuiltinOperator_GREATER ((tflite_BuiltinOperator_enum_t)INT32_C(61))
#define tflite_BuiltinOperator_GREATER_EQUAL ((tflite_BuiltinOperator_enum_t)INT32_C(62))
#define tflite_BuiltinOperator_LESS_EQUAL ((tflite_BuiltinOperator_enum_t)INT32_C(63))
#define tflite_BuiltinOperator_SELECT ((tflite_BuiltinOperator_enum_t)INT32_C(64))
#define tflite_BuiltinOperator_SLICE ((tflite_BuiltinOperator_enum_t)INT32_C(65))
#define tflite_BuiltinOperator_SIN ((tflite_BuiltinOperator_enum_t)INT32_C(66))
#define tflite_BuiltinOperator_TRANSPOSE_CONV ((tflite_BuiltinOperator_enum_t)INT32_C(67))
#define tflite_BuiltinOperator_SPARSE_TO_DENSE ((tflite_BuiltinOperator_enum_t)INT32_C(68))
#define tflite_BuiltinOperator_TILE ((tflite_BuiltinOperator_enum_t)INT32_C(69))
#define tflite_BuiltinOperator_EXPAND_DIMS ((tflite_BuiltinOperator_enum_t)INT32_C(70))
#define tflite_BuiltinOperator_EQUAL ((tflite_BuiltinOperator_enum_t)INT32_C(71))
#define tflite_BuiltinOperator_NOT_EQUAL ((tflite_BuiltinOperator_enum_t)INT32_C(72))
#define tflite_BuiltinOperator_LOG ((tflite_BuiltinOperator_enum_t)INT32_C(73))
#define tflite_BuiltinOperator_SUM ((tflite_BuiltinOperator_enum_t)INT32_C(74))
#define tflite_BuiltinOperator_SQRT ((tflite_BuiltinOperator_enum_t)INT32_C(75))
#define tflite_BuiltinOperator_RSQRT ((tflite_BuiltinOperator_enum_t)INT32_C(76))
#define tflite_BuiltinOperator_SHAPE ((tflite_BuiltinOperator_enum_t)INT32_C(77))
#define tflite_BuiltinOperator_POW ((tflite_BuiltinOperator_enum_t)INT32_C(78))
#define tflite_BuiltinOperator_ARG_MIN ((tflite_BuiltinOperator_enum_t)INT32_C(79))
#define tflite_BuiltinOperator_FAKE_QUANT ((tflite_BuiltinOperator_enum_t)INT32_C(80))
#define tflite_BuiltinOperator_REDUCE_PROD ((tflite_BuiltinOperator_enum_t)INT32_C(81))
#define tflite_BuiltinOperator_REDUCE_MAX ((tflite_BuiltinOperator_enum_t)INT32_C(82))
#define tflite_BuiltinOperator_PACK ((tflite_BuiltinOperator_enum_t)INT32_C(83))
#define tflite_BuiltinOperator_LOGICAL_OR ((tflite_BuiltinOperator_enum_t)INT32_C(84))
#define tflite_BuiltinOperator_ONE_HOT ((tflite_BuiltinOperator_enum_t)INT32_C(85))
#define tflite_BuiltinOperator_LOGICAL_AND ((tflite_BuiltinOperator_enum_t)INT32_C(86))
#define tflite_BuiltinOperator_LOGICAL_NOT ((tflite_BuiltinOperator_enum_t)INT32_C(87))
#define tflite_BuiltinOperator_UNPACK ((tflite_BuiltinOperator_enum_t)INT32_C(88))
#define tflite_BuiltinOperator_REDUCE_MIN ((tflite_BuiltinOperator_enum_t)INT32_C(89))
#define tflite_BuiltinOperator_FLOOR_DIV ((tflite_BuiltinOperator_enum_t)INT32_C(90))
#define tflite_BuiltinOperator_REDUCE_ANY ((tflite_BuiltinOperator_enum_t)INT32_C(91))
#define tflite_BuiltinOperator_SQUARE ((tflite_BuiltinOperator_enum_t)INT32_C(92))
#define tflite_BuiltinOperator_ZEROS_LIKE ((tflite_BuiltinOperator_enum_t)INT32_C(93))
#define tflite_BuiltinOperator_FILL ((tflite_BuiltinOperator_enum_t)INT32_C(94))
#define tflite_BuiltinOperator_FLOOR_MOD ((tflite_BuiltinOperator_enum_t)INT32_C(95))
#define tflite_BuiltinOperator_RANGE ((tflite_BuiltinOperator_enum_t)INT32_C(96))
#define tflite_BuiltinOperator_RESIZE_NEAREST_NEIGHBOR ((tflite_BuiltinOperator_enum_t)INT32_C(97))
#define tflite_BuiltinOperator_LEAKY_RELU ((tflite_BuiltinOperator_enum_t)INT32_C(98))
#define tflite_BuiltinOperator_SQUARED_DIFFERENCE ((tflite_BuiltinOperator_enum_t)INT32_C(99))
#define tflite_BuiltinOperator_MIRROR_PAD ((tflite_BuiltinOperator_enum_t)INT32_C(100))
#define tflite_BuiltinOperator_ABS ((tflite_BuiltinOperator_enum_t)INT32_C(101))
#define tflite_BuiltinOperator_SPLIT_V ((tflite_BuiltinOperator_enum_t)INT32_C(102))
#define tflite_BuiltinOperator_UNIQUE ((tflite_BuiltinOperator_enum_t)INT32_C(103))
#define tflite_BuiltinOperator_CEIL ((tflite_BuiltinOperator_enum_t)INT32_C(104))
#define tflite_BuiltinOperator_REVERSE_V2 ((tflite_BuiltinOperator_enum_t)INT32_C(105))
#define tflite_BuiltinOperator_ADD_N ((tflite_BuiltinOperator_enum_t)INT32_C(106))
#define tflite_BuiltinOperator_GATHER_ND ((tflite_BuiltinOperator_enum_t)INT32_C(107))
#define tflite_BuiltinOperator_COS ((tflite_BuiltinOperator_enum_t)INT32_C(108))
#define tflite_BuiltinOperator_WHERE ((tflite_BuiltinOperator_enum_t)INT32_C(109))
#define tflite_BuiltinOperator_RANK ((tflite_BuiltinOperator_enum_t)INT32_C(110))
#define tflite_BuiltinOperator_ELU ((tflite_BuiltinOperator_enum_t)INT32_C(111))
#define tflite_BuiltinOperator_REVERSE_SEQUENCE ((tflite_BuiltinOperator_enum_t)INT32_C(112))
#define tflite_BuiltinOperator_MATRIX_DIAG ((tflite_BuiltinOperator_enum_t)INT32_C(113))
#define tflite_BuiltinOperator_QUANTIZE ((tflite_BuiltinOperator_enum_t)INT32_C(114))
#define tflite_BuiltinOperator_MATRIX_SET_DIAG ((tflite_BuiltinOperator_enum_t)INT32_C(115))
#define tflite_BuiltinOperator_ROUND ((tflite_BuiltinOperator_enum_t)INT32_C(116))
#define tflite_BuiltinOperator_HARD_SWISH ((tflite_BuiltinOperator_enum_t)INT32_C(117))
#define tflite_BuiltinOperator_IF ((tflite_BuiltinOperator_enum_t)INT32_C(118))
#define tflite_BuiltinOperator_WHILE ((tflite_BuiltinOperator_enum_t)INT32_C(119))
#define tflite_BuiltinOperator_NON_MAX_SUPPRESSION_V4 ((tflite_BuiltinOperator_enum_t)INT32_C(120))
#define tflite_BuiltinOperator_NON_MAX_SUPPRESSION_V5 ((tflite_BuiltinOperator_enum_t)INT32_C(121))
#define tflite_BuiltinOperator_SCATTER_ND ((tflite_BuiltinOperator_enum_t)INT32_C(122))
#define tflite_BuiltinOperator_SELECT_V2 ((tflite_BuiltinOperator_enum_t)INT32_C(123))
#define tflite_BuiltinOperator_DENSIFY ((tflite_BuiltinOperator_enum_t)INT32_C(124))
#define tflite_BuiltinOperator_SEGMENT_SUM ((tflite_BuiltinOperator_enum_t)INT32_C(125))
#define tflite_BuiltinOperator_BATCH_MATMUL ((tflite_BuiltinOperator_enum_t)INT32_C(126))
#define tflite_BuiltinOperator_PLACEHOLDER_FOR_GREATER_OP_CODES ((tflite_BuiltinOperator_enum_t)INT32_C(127))
#define tflite_BuiltinOperator_CUMSUM ((tflite_BuiltinOperator_enum_t)INT32_C(128))
#define tflite_BuiltinOperator_CALL_ONCE ((tflite_BuiltinOperator_enum_t)INT32_C(129))
#define tflite_BuiltinOperator_BROADCAST_TO ((tflite_BuiltinOperator_enum_t)INT32_C(130))
#define tflite_BuiltinOperator_RFFT2D ((tflite_BuiltinOperator_enum_t)INT32_C(131))
#define tflite_BuiltinOperator_CONV_3D ((tflite_BuiltinOperator_enum_t)INT32_C(132))
#define tflite_BuiltinOperator_IMAG ((tflite_BuiltinOperator_enum_t)INT32_C(133))
#define tflite_BuiltinOperator_REAL ((tflite_BuiltinOperator_enum_t)INT32_C(134))
#define tflite_BuiltinOperator_COMPLEX_ABS ((tflite_BuiltinOperator_enum_t)INT32_C(135))
#define tflite_BuiltinOperator_HASHTABLE ((tflite_BuiltinOperator_enum_t)INT32_C(136))
#define tflite_BuiltinOperator_HASHTABLE_FIND ((tflite_BuiltinOperator_enum_t)INT32_C(137))
#define tflite_BuiltinOperator_HASHTABLE_IMPORT ((tflite_BuiltinOperator_enum_t)INT32_C(138))
#define tflite_BuiltinOperator_HASHTABLE_SIZE ((tflite_BuiltinOperator_enum_t)INT32_C(139))
#define tflite_BuiltinOperator_REDUCE_ALL ((tflite_BuiltinOperator_enum_t)INT32_C(140))
#define tflite_BuiltinOperator_CONV_3D_TRANSPOSE ((tflite_BuiltinOperator_enum_t)INT32_C(141))
#define tflite_BuiltinOperator_VAR_HANDLE ((tflite_BuiltinOperator_enum_t)INT32_C(142))
#define tflite_BuiltinOperator_READ_VARIABLE ((tflite_BuiltinOperator_enum_t)INT32_C(143))
#define tflite_BuiltinOperator_ASSIGN_VARIABLE ((tflite_BuiltinOperator_enum_t)INT32_C(144))
#define tflite_BuiltinOperator_BROADCAST_ARGS ((tflite_BuiltinOperator_enum_t)INT32_C(145))
#define tflite_BuiltinOperator_RANDOM_STANDARD_NORMAL ((tflite_BuiltinOperator_enum_t)INT32_C(146))
#define tflite_BuiltinOperator_BUCKETIZE ((tflite_BuiltinOperator_enum_t)INT32_C(147))
#define tflite_BuiltinOperator_RANDOM_UNIFORM ((tflite_BuiltinOperator_enum_t)INT32_C(148))
#define tflite_BuiltinOperator_MULTINOMIAL ((tflite_BuiltinOperator_enum_t)INT32_C(149))
#define tflite_BuiltinOperator_GELU ((tflite_BuiltinOperator_enum_t)INT32_C(150))
#define tflite_BuiltinOperator_DYNAMIC_UPDATE_SLICE ((tflite_BuiltinOperator_enum_t)INT32_C(151))
#define tflite_BuiltinOperator_RELU_0_TO_1 ((tflite_BuiltinOperator_enum_t)INT32_C(152))
#define tflite_BuiltinOperator_UNSORTED_SEGMENT_PROD ((tflite_BuiltinOperator_enum_t)INT32_C(153))
#define tflite_BuiltinOperator_UNSORTED_SEGMENT_MAX ((tflite_BuiltinOperator_enum_t)INT32_C(154))
#define tflite_BuiltinOperator_UNSORTED_SEGMENT_SUM ((tflite_BuiltinOperator_enum_t)INT32_C(155))
#define tflite_BuiltinOperator_ATAN2 ((tflite_BuiltinOperator_enum_t)INT32_C(156))
...
static inline const char *tflite_BuiltinOperator_name(tflite_BuiltinOperator_enum_t value)
{
    ...
    case tflite_BuiltinOperator_BATCH_MATMUL: return "BATCH_MATMUL";
    case tflite_BuiltinOperator_PLACEHOLDER_FOR_GREATER_OP_CODES: return "PLACEHOLDER_FOR_GREATER_OP_CODES";
    case tflite_BuiltinOperator_CUMSUM: return "CUMSUM";
    case tflite_BuiltinOperator_CALL_ONCE: return "CALL_ONCE";
    case tflite_BuiltinOperator_BROADCAST_TO: return "BROADCAST_TO";
    case tflite_BuiltinOperator_RFFT2D: return "RFFT2D";
    case tflite_BuiltinOperator_CONV_3D: return "CONV_3D";
    case tflite_BuiltinOperator_IMAG: return "IMAG";
    case tflite_BuiltinOperator_REAL: return "REAL";
    case tflite_BuiltinOperator_COMPLEX_ABS: return "COMPLEX_ABS";
    case tflite_BuiltinOperator_HASHTABLE: return "HASHTABLE";
    case tflite_BuiltinOperator_HASHTABLE_FIND: return "HASHTABLE_FIND";
    case tflite_BuiltinOperator_HASHTABLE_IMPORT: return "HASHTABLE_IMPORT";
    case tflite_BuiltinOperator_HASHTABLE_SIZE: return "HASHTABLE_SIZE";
    case tflite_BuiltinOperator_REDUCE_ALL: return "REDUCE_ALL";
    case tflite_BuiltinOperator_CONV_3D_TRANSPOSE: return "CONV_3D_TRANSPOSE";
    case tflite_BuiltinOperator_VAR_HANDLE: return "VAR_HANDLE";
    case tflite_BuiltinOperator_READ_VARIABLE: return "READ_VARIABLE";
    case tflite_BuiltinOperator_ASSIGN_VARIABLE: return "ASSIGN_VARIABLE";
    case tflite_BuiltinOperator_BROADCAST_ARGS: return "BROADCAST_ARGS";
    case tflite_BuiltinOperator_RANDOM_STANDARD_NORMAL: return "RANDOM_STANDARD_NORMAL";
    case tflite_BuiltinOperator_BUCKETIZE: return "BUCKETIZE";
    case tflite_BuiltinOperator_RANDOM_UNIFORM: return "RANDOM_UNIFORM";
    case tflite_BuiltinOperator_MULTINOMIAL: return "MULTINOMIAL";
    case tflite_BuiltinOperator_GELU: return "GELU";
    case tflite_BuiltinOperator_DYNAMIC_UPDATE_SLICE: return "DYNAMIC_UPDATE_SLICE";
    case tflite_BuiltinOperator_RELU_0_TO_1: return "RELU_0_TO_1";
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_PROD: return "UNSORTED_SEGMENT_PROD";
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_MAX: return "UNSORTED_SEGMENT_MAX";
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_SUM: return "UNSORTED_SEGMENT_SUM";
    case tflite_BuiltinOperator_ATAN2: return "ATAN2";
    default: return "";
    }
}
...
static inline int tflite_BuiltinOperator_is_known_value(tflite_BuiltinOperator_enum_t value)
{
    ...
    case tflite_BuiltinOperator_BATCH_MATMUL: return 1;
    case tflite_BuiltinOperator_PLACEHOLDER_FOR_GREATER_OP_CODES: return 1;
    case tflite_BuiltinOperator_CUMSUM: return 1;
    case tflite_BuiltinOperator_CALL_ONCE: return 1;
    case tflite_BuiltinOperator_BROADCAST_TO: return 1;
    case tflite_BuiltinOperator_RFFT2D: return 1;
    case tflite_BuiltinOperator_CONV_3D: return 1;
    case tflite_BuiltinOperator_IMAG: return 1;
    case tflite_BuiltinOperator_REAL: return 1;
    case tflite_BuiltinOperator_COMPLEX_ABS: return 1;
    case tflite_BuiltinOperator_HASHTABLE: return 1;
    case tflite_BuiltinOperator_HASHTABLE_FIND: return 1;
    case tflite_BuiltinOperator_HASHTABLE_IMPORT: return 1;
    case tflite_BuiltinOperator_HASHTABLE_SIZE: return 1;
    case tflite_BuiltinOperator_REDUCE_ALL: return 1;
    case tflite_BuiltinOperator_CONV_3D_TRANSPOSE: return 1;
    case tflite_BuiltinOperator_VAR_HANDLE: return 1;
    case tflite_BuiltinOperator_READ_VARIABLE: return 1;
    case tflite_BuiltinOperator_ASSIGN_VARIABLE: return 1;
    case tflite_BuiltinOperator_BROADCAST_ARGS: return 1;
    case tflite_BuiltinOperator_RANDOM_STANDARD_NORMAL: return 1;
    case tflite_BuiltinOperator_BUCKETIZE: return 1;
    case tflite_BuiltinOperator_RANDOM_UNIFORM: return 1;
    case tflite_BuiltinOperator_MULTINOMIAL: return 1;
    case tflite_BuiltinOperator_GELU: return 1;
    case tflite_BuiltinOperator_DYNAMIC_UPDATE_SLICE: return 1;
    case tflite_BuiltinOperator_RELU_0_TO_1: return 1;
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_PROD: return 1;
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_MAX: return 1;
    case tflite_BuiltinOperator_UNSORTED_SEGMENT_SUM: return 1;
    case tflite_BuiltinOperator_ATAN2: return 1;
    default: return 0;
    }
}
...
__flatbuffers_define_scalar_field(8, tflite_Tensor, has_rank, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
#define tflite_BuiltinOptions_BatchMatMulOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(101))
#define tflite_BuiltinOptions_CumsumOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(102))
#define tflite_BuiltinOptions_CallOnceOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(103))
#define tflite_BuiltinOptions_BroadcastToOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(104))
#define tflite_BuiltinOptions_Rfft2dOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(105))
#define tflite_BuiltinOptions_Conv3DOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(106))
#define tflite_BuiltinOptions_HashtableOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(107))
#define tflite_BuiltinOptions_HashtableFindOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(108))
#define tflite_BuiltinOptions_HashtableImportOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(109))
#define tflite_BuiltinOptions_HashtableSizeOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(110))
#define tflite_BuiltinOptions_VarHandleOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(111))
#define tflite_BuiltinOptions_ReadVariableOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(112))
#define tflite_BuiltinOptions_AssignVariableOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(113))
#define tflite_BuiltinOptions_RandomOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(114))
#define tflite_BuiltinOptions_BucketizeOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(115))
#define tflite_BuiltinOptions_GeluOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(116))
#define tflite_BuiltinOptions_DynamicUpdateSliceOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(117))
#define tflite_BuiltinOptions_UnsortedSegmentProdOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(118))
#define tflite_BuiltinOptions_UnsortedSegmentMaxOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(119))
#define tflite_BuiltinOptions_UnsortedSegmentSumOptions ((tflite_BuiltinOptions_union_type_t)UINT8_C(120))
#define tflite_BuiltinOptions_ATan2Options ((tflite_BuiltinOptions_union_type_t)UINT8_C(121))
...
static inline const char *tflite_BuiltinOptions_type_name(tflite_BuiltinOptions_union_type_t type)
{
    ...
    case tflite_BuiltinOptions_BatchMatMulOptions: return "BatchMatMulOptions";
    case tflite_BuiltinOptions_CumsumOptions: return "CumsumOptions";
    case tflite_BuiltinOptions_CallOnceOptions: return "CallOnceOptions";
    case tflite_BuiltinOptions_BroadcastToOptions: return "BroadcastToOptions";
    case tflite_BuiltinOptions_Rfft2dOptions: return "Rfft2dOptions";
    case tflite_BuiltinOptions_Conv3DOptions: return "Conv3DOptions";
    case tflite_BuiltinOptions_HashtableOptions: return "HashtableOptions";
    case tflite_BuiltinOptions_HashtableFindOptions: return "HashtableFindOptions";
    case tflite_BuiltinOptions_HashtableImportOptions: return "HashtableImportOptions";
    case tflite_BuiltinOptions_HashtableSizeOptions: return "HashtableSizeOptions";
    case tflite_BuiltinOptions_VarHandleOptions: return "VarHandleOptions";
    case tflite_BuiltinOptions_ReadVariableOptions: return "ReadVariableOptions";
    case tflite_BuiltinOptions_AssignVariableOptions: return "AssignVariableOptions";
    case tflite_BuiltinOptions_RandomOptions: return "RandomOptions";
    case tflite_BuiltinOptions_BucketizeOptions: return "BucketizeOptions";
    case tflite_BuiltinOptions_GeluOptions: return "GeluOptions";
    case tflite_BuiltinOptions_DynamicUpdateSliceOptions: return "DynamicUpdateSliceOptions";
    case tflite_BuiltinOptions_UnsortedSegmentProdOptions: return "UnsortedSegmentProdOptions";
    case tflite_BuiltinOptions_UnsortedSegmentMaxOptions: return "UnsortedSegmentMaxOptions";
    case tflite_BuiltinOptions_UnsortedSegmentSumOptions: return "UnsortedSegmentSumOptions";
    case tflite_BuiltinOptions_ATan2Options: return "ATan2Options";
    default: return "";
    }
}
...
static inline int tflite_BuiltinOptions_is_known_type(tflite_BuiltinOptions_union_type_t type)
{
    ...
    case tflite_BuiltinOptions_BatchMatMulOptions: return 1;
    case tflite_BuiltinOptions_CumsumOptions: return 1;
    case tflite_BuiltinOptions_CallOnceOptions: return 1;
    case tflite_BuiltinOptions_BroadcastToOptions: return 1;
    case tflite_BuiltinOptions_Rfft2dOptions: return 1;
    case tflite_BuiltinOptions_Conv3DOptions: return 1;
    case tflite_BuiltinOptions_HashtableOptions: return 1;
    case tflite_BuiltinOptions_HashtableFindOptions: return 1;
    case tflite_BuiltinOptions_HashtableImportOptions: return 1;
    case tflite_BuiltinOptions_HashtableSizeOptions: return 1;
    case tflite_BuiltinOptions_VarHandleOptions: return 1;
    case tflite_BuiltinOptions_ReadVariableOptions: return 1;
    case tflite_BuiltinOptions_AssignVariableOptions: return 1;
    case tflite_BuiltinOptions_RandomOptions: return 1;
    case tflite_BuiltinOptions_BucketizeOptions: return 1;
    case tflite_BuiltinOptions_GeluOptions: return 1;
    case tflite_BuiltinOptions_DynamicUpdateSliceOptions: return 1;
    case tflite_BuiltinOptions_UnsortedSegmentProdOptions: return 1;
    case tflite_BuiltinOptions_UnsortedSegmentMaxOptions: return 1;
    case tflite_BuiltinOptions_UnsortedSegmentSumOptions: return 1;
    case tflite_BuiltinOptions_ATan2Options: return 1;
    default: return 0;
    }
}
...
struct tflite_Conv3DOptions_table { uint8_t unused__; };

static inline size_t tflite_Conv3DOptions_vec_len(tflite_Conv3DOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_Conv3DOptions_table_t tflite_Conv3DOptions_vec_at(tflite_Conv3DOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_Conv3DOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_Conv3DOptions)

__flatbuffers_define_scalar_field(0, tflite_Conv3DOptions, padding, tflite_Padding, tflite_Padding_enum_t, INT8_C(0))
__flatbuffers_define_scalar_field(1, tflite_Conv3DOptions, stride_d, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(2, tflite_Conv3DOptions, stride_w, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(3, tflite_Conv3DOptions, stride_h, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(4, tflite_Conv3DOptions, fused_activation_function, tflite_ActivationFunctionType, tflite_ActivationFunctionType_enum_t, INT8_C(0))
__flatbuffers_define_scalar_field(5, tflite_Conv3DOptions, dilation_d_factor, flatbuffers_int32, int32_t, INT32_C(1))
__flatbuffers_define_scalar_field(6, tflite_Conv3DOptions, dilation_w_factor, flatbuffers_int32, int32_t, INT32_C(1))
__flatbuffers_define_scalar_field(7, tflite_Conv3DOptions, dilation_h_factor, flatbuffers_int32, int32_t, INT32_C(1))
...
__flatbuffers_define_scalar_field(2, tflite_SVDFOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(1, tflite_RNNOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(2, tflite_SequenceRNNOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(3, tflite_BidirectionalSequenceRNNOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(3, tflite_FullyConnectedOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(1, tflite_AddOptions, pot_scale_int16, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(1))
...
__flatbuffers_define_scalar_field(4, tflite_LSTMOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(4, tflite_UnidirectionalSequenceLSTMOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(5, tflite_BidirectionalSequenceLSTMOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(1, tflite_ResizeNearestNeighborOptions, half_pixel_centers, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
...
__flatbuffers_define_scalar_field(1, tflite_SubOptions, pot_scale_int16, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(1))
...
__flatbuffers_define_scalar_field(1, tflite_GatherOptions, batch_dims, flatbuffers_int32, int32_t, INT32_C(0))
...
struct tflite_CallOnceOptions_table { uint8_t unused__; };

static inline size_t tflite_CallOnceOptions_vec_len(tflite_CallOnceOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_CallOnceOptions_table_t tflite_CallOnceOptions_vec_at(tflite_CallOnceOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_CallOnceOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_CallOnceOptions)

__flatbuffers_define_scalar_field(0, tflite_CallOnceOptions, init_subgraph_index, flatbuffers_int32, int32_t, INT32_C(0))
...
struct tflite_BatchMatMulOptions_table { uint8_t unused__; };

static inline size_t tflite_BatchMatMulOptions_vec_len(tflite_BatchMatMulOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_BatchMatMulOptions_table_t tflite_BatchMatMulOptions_vec_at(tflite_BatchMatMulOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_BatchMatMulOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_BatchMatMulOptions)

__flatbuffers_define_scalar_field(0, tflite_BatchMatMulOptions, adj_x, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
__flatbuffers_define_scalar_field(1, tflite_BatchMatMulOptions, adj_y, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
__flatbuffers_define_scalar_field(2, tflite_BatchMatMulOptions, asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))

struct tflite_CumsumOptions_table { uint8_t unused__; };

static inline size_t tflite_CumsumOptions_vec_len(tflite_CumsumOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_CumsumOptions_table_t tflite_CumsumOptions_vec_at(tflite_CumsumOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_CumsumOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_CumsumOptions)

__flatbuffers_define_scalar_field(0, tflite_CumsumOptions, exclusive, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))
__flatbuffers_define_scalar_field(1, tflite_CumsumOptions, reverse, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))

struct tflite_BroadcastToOptions_table { uint8_t unused__; };

static inline size_t tflite_BroadcastToOptions_vec_len(tflite_BroadcastToOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_BroadcastToOptions_table_t tflite_BroadcastToOptions_vec_at(tflite_BroadcastToOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_BroadcastToOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_BroadcastToOptions)


struct tflite_Rfft2dOptions_table { uint8_t unused__; };

static inline size_t tflite_Rfft2dOptions_vec_len(tflite_Rfft2dOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_Rfft2dOptions_table_t tflite_Rfft2dOptions_vec_at(tflite_Rfft2dOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_Rfft2dOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_Rfft2dOptions)


struct tflite_HashtableOptions_table { uint8_t unused__; };

static inline size_t tflite_HashtableOptions_vec_len(tflite_HashtableOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_HashtableOptions_table_t tflite_HashtableOptions_vec_at(tflite_HashtableOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_HashtableOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_HashtableOptions)

__flatbuffers_define_scalar_field(0, tflite_HashtableOptions, table_id, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(1, tflite_HashtableOptions, key_dtype, tflite_TensorType, tflite_TensorType_enum_t, INT8_C(0))
__flatbuffers_define_scalar_field(2, tflite_HashtableOptions, value_dtype, tflite_TensorType, tflite_TensorType_enum_t, INT8_C(0))

struct tflite_HashtableFindOptions_table { uint8_t unused__; };

static inline size_t tflite_HashtableFindOptions_vec_len(tflite_HashtableFindOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_HashtableFindOptions_table_t tflite_HashtableFindOptions_vec_at(tflite_HashtableFindOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_HashtableFindOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_HashtableFindOptions)


struct tflite_HashtableImportOptions_table { uint8_t unused__; };

static inline size_t tflite_HashtableImportOptions_vec_len(tflite_HashtableImportOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_HashtableImportOptions_table_t tflite_HashtableImportOptions_vec_at(tflite_HashtableImportOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_HashtableImportOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_HashtableImportOptions)


struct tflite_HashtableSizeOptions_table { uint8_t unused__; };

static inline size_t tflite_HashtableSizeOptions_vec_len(tflite_HashtableSizeOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_HashtableSizeOptions_table_t tflite_HashtableSizeOptions_vec_at(tflite_HashtableSizeOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_HashtableSizeOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_HashtableSizeOptions)


struct tflite_VarHandleOptions_table { uint8_t unused__; };

static inline size_t tflite_VarHandleOptions_vec_len(tflite_VarHandleOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_VarHandleOptions_table_t tflite_VarHandleOptions_vec_at(tflite_VarHandleOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_VarHandleOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_VarHandleOptions)

__flatbuffers_define_string_field(0, tflite_VarHandleOptions, container, 0)
__flatbuffers_define_string_field(1, tflite_VarHandleOptions, shared_name, 0)

struct tflite_ReadVariableOptions_table { uint8_t unused__; };

static inline size_t tflite_ReadVariableOptions_vec_len(tflite_ReadVariableOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_ReadVariableOptions_table_t tflite_ReadVariableOptions_vec_at(tflite_ReadVariableOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_ReadVariableOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_ReadVariableOptions)


struct tflite_AssignVariableOptions_table { uint8_t unused__; };

static inline size_t tflite_AssignVariableOptions_vec_len(tflite_AssignVariableOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_AssignVariableOptions_table_t tflite_AssignVariableOptions_vec_at(tflite_AssignVariableOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_AssignVariableOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_AssignVariableOptions)


struct tflite_RandomOptions_table { uint8_t unused__; };

static inline size_t tflite_RandomOptions_vec_len(tflite_RandomOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_RandomOptions_table_t tflite_RandomOptions_vec_at(tflite_RandomOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_RandomOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_RandomOptions)

__flatbuffers_define_scalar_field(0, tflite_RandomOptions, seed, flatbuffers_int64, int64_t, INT64_C(0))
__flatbuffers_define_scalar_field(1, tflite_RandomOptions, seed2, flatbuffers_int64, int64_t, INT64_C(0))

struct tflite_BucketizeOptions_table { uint8_t unused__; };

static inline size_t tflite_BucketizeOptions_vec_len(tflite_BucketizeOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_BucketizeOptions_table_t tflite_BucketizeOptions_vec_at(tflite_BucketizeOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_BucketizeOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_BucketizeOptions)

__flatbuffers_define_vector_field(0, tflite_BucketizeOptions, boundaries, flatbuffers_float_vec_t, 0)

struct tflite_GeluOptions_table { uint8_t unused__; };

static inline size_t tflite_GeluOptions_vec_len(tflite_GeluOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_GeluOptions_table_t tflite_GeluOptions_vec_at(tflite_GeluOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_GeluOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_GeluOptions)

__flatbuffers_define_scalar_field(0, tflite_GeluOptions, approximate, flatbuffers_bool, flatbuffers_bool_t, UINT8_C(0))

struct tflite_DynamicUpdateSliceOptions_table { uint8_t unused__; };

static inline size_t tflite_DynamicUpdateSliceOptions_vec_len(tflite_DynamicUpdateSliceOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_DynamicUpdateSliceOptions_table_t tflite_DynamicUpdateSliceOptions_vec_at(tflite_DynamicUpdateSliceOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_DynamicUpdateSliceOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_DynamicUpdateSliceOptions)


struct tflite_UnsortedSegmentProdOptions_table { uint8_t unused__; };

static inline size_t tflite_UnsortedSegmentProdOptions_vec_len(tflite_UnsortedSegmentProdOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_UnsortedSegmentProdOptions_table_t tflite_UnsortedSegmentProdOptions_vec_at(tflite_UnsortedSegmentProdOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_UnsortedSegmentProdOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_UnsortedSegmentProdOptions)


struct tflite_UnsortedSegmentMaxOptions_table { uint8_t unused__; };

static inline size_t tflite_UnsortedSegmentMaxOptions_vec_len(tflite_UnsortedSegmentMaxOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_UnsortedSegmentMaxOptions_table_t tflite_UnsortedSegmentMaxOptions_vec_at(tflite_UnsortedSegmentMaxOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_UnsortedSegmentMaxOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_UnsortedSegmentMaxOptions)


struct tflite_UnsortedSegmentSumOptions_table { uint8_t unused__; };

static inline size_t tflite_UnsortedSegmentSumOptions_vec_len(tflite_UnsortedSegmentSumOptions_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_UnsortedSegmentSumOptions_table_t tflite_UnsortedSegmentSumOptions_vec_at(tflite_UnsortedSegmentSumOptions_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_UnsortedSegmentSumOptions_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_UnsortedSegmentSumOptions)


struct tflite_ATan2Options_table { uint8_t unused__; };

static inline size_t tflite_ATan2Options_vec_len(tflite_ATan2Options_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_ATan2Options_table_t tflite_ATan2Options_vec_at(tflite_ATan2Options_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_ATan2Options_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_ATan2Options)
...
__flatbuffers_define_scalar_field(0, tflite_OperatorCode, deprecated_builtin_code, flatbuffers_int8, int8_t, INT8_C(0))
...
__flatbuffers_define_scalar_field(3, tflite_OperatorCode, builtin_code, tflite_BuiltinOperator, tflite_BuiltinOperator_enum_t, INT32_C(0))
...
struct tflite_TensorMap_table { uint8_t unused__; };

static inline size_t tflite_TensorMap_vec_len(tflite_TensorMap_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_TensorMap_table_t tflite_TensorMap_vec_at(tflite_TensorMap_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_TensorMap_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_TensorMap)

__flatbuffers_define_string_field(0, tflite_TensorMap, name, 0)
__flatbuffers_define_scalar_field(1, tflite_TensorMap, tensor_index, flatbuffers_uint32, uint32_t, UINT32_C(0))

struct tflite_SignatureDef_table { uint8_t unused__; };

static inline size_t tflite_SignatureDef_vec_len(tflite_SignatureDef_vec_t vec)
__flatbuffers_vec_len(vec)
static inline tflite_SignatureDef_table_t tflite_SignatureDef_vec_at(tflite_SignatureDef_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(tflite_SignatureDef_table_t, vec, i, 0)
__flatbuffers_table_as_root(tflite_SignatureDef)

__flatbuffers_define_vector_field(0, tflite_SignatureDef, inputs, tflite_TensorMap_vec_t, 0)
__flatbuffers_define_vector_field(1, tflite_SignatureDef, outputs, tflite_TensorMap_vec_t, 0)
__flatbuffers_define_string_field(2, tflite_SignatureDef, signature_key, 0)
/* Skipping deprecated field: 'tflite_SignatureDef_deprecated_tag' */

__flatbuffers_define_scalar_field(4, tflite_SignatureDef, subgraph_index, flatbuffers_uint32, uint32_t, UINT32_C(0))
...
__flatbuffers_define_vector_field(7, tflite_Model, signature_defs, tflite_SignatureDef_vec_t, 0)
...
__flatbuffers_build_table(flatbuffers_, tflite_Tensor, 9)
...
static const flatbuffers_voffset_t __tflite_Conv3DOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_Conv3DOptions_ref_t;
static tflite_Conv3DOptions_ref_t tflite_Conv3DOptions_clone(flatbuffers_builder_t *B, tflite_Conv3DOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_Conv3DOptions, 8)
...
__flatbuffers_build_table(flatbuffers_, tflite_SVDFOptions, 3)
...
__flatbuffers_build_table(flatbuffers_, tflite_RNNOptions, 2)
...
__flatbuffers_build_table(flatbuffers_, tflite_SequenceRNNOptions, 3)
...
__flatbuffers_build_table(flatbuffers_, tflite_BidirectionalSequenceRNNOptions, 4)
...
__flatbuffers_build_table(flatbuffers_, tflite_FullyConnectedOptions, 4)
...
__flatbuffers_build_table(flatbuffers_, tflite_AddOptions, 2)
...
__flatbuffers_build_table(flatbuffers_, tflite_LSTMOptions, 5)
...
__flatbuffers_build_table(flatbuffers_, tflite_UnidirectionalSequenceLSTMOptions, 5)
...
__flatbuffers_build_table(flatbuffers_, tflite_BidirectionalSequenceLSTMOptions, 6)
...
__flatbuffers_build_table(flatbuffers_, tflite_ResizeNearestNeighborOptions, 2)
...
__flatbuffers_build_table(flatbuffers_, tflite_SubOptions, 2)
...
__flatbuffers_build_table(flatbuffers_, tflite_GatherOptions, 2)
...
static const flatbuffers_voffset_t __tflite_CallOnceOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_CallOnceOptions_ref_t;
static tflite_CallOnceOptions_ref_t tflite_CallOnceOptions_clone(flatbuffers_builder_t *B, tflite_CallOnceOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_CallOnceOptions, 1)
...
static const flatbuffers_voffset_t __tflite_BatchMatMulOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_BatchMatMulOptions_ref_t;
static tflite_BatchMatMulOptions_ref_t tflite_BatchMatMulOptions_clone(flatbuffers_builder_t *B, tflite_BatchMatMulOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_BatchMatMulOptions, 3)

static const flatbuffers_voffset_t __tflite_CumsumOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_CumsumOptions_ref_t;
static tflite_CumsumOptions_ref_t tflite_CumsumOptions_clone(flatbuffers_builder_t *B, tflite_CumsumOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_CumsumOptions, 2)

static const flatbuffers_voffset_t __tflite_BroadcastToOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_BroadcastToOptions_ref_t;
static tflite_BroadcastToOptions_ref_t tflite_BroadcastToOptions_clone(flatbuffers_builder_t *B, tflite_BroadcastToOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_BroadcastToOptions, 0)

static const flatbuffers_voffset_t __tflite_Rfft2dOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_Rfft2dOptions_ref_t;
static tflite_Rfft2dOptions_ref_t tflite_Rfft2dOptions_clone(flatbuffers_builder_t *B, tflite_Rfft2dOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_Rfft2dOptions, 0)

static const flatbuffers_voffset_t __tflite_HashtableOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_HashtableOptions_ref_t;
static tflite_HashtableOptions_ref_t tflite_HashtableOptions_clone(flatbuffers_builder_t *B, tflite_HashtableOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_HashtableOptions, 3)

static const flatbuffers_voffset_t __tflite_HashtableFindOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_HashtableFindOptions_ref_t;
static tflite_HashtableFindOptions_ref_t tflite_HashtableFindOptions_clone(flatbuffers_builder_t *B, tflite_HashtableFindOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_HashtableFindOptions, 0)

static const flatbuffers_voffset_t __tflite_HashtableImportOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_HashtableImportOptions_ref_t;
static tflite_HashtableImportOptions_ref_t tflite_HashtableImportOptions_clone(flatbuffers_builder_t *B, tflite_HashtableImportOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_HashtableImportOptions, 0)

static const flatbuffers_voffset_t __tflite_HashtableSizeOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_HashtableSizeOptions_ref_t;
static tflite_HashtableSizeOptions_ref_t tflite_HashtableSizeOptions_clone(flatbuffers_builder_t *B, tflite_HashtableSizeOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_HashtableSizeOptions, 0)

static const flatbuffers_voffset_t __tflite_VarHandleOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_VarHandleOptions_ref_t;
static tflite_VarHandleOptions_ref_t tflite_VarHandleOptions_clone(flatbuffers_builder_t *B, tflite_VarHandleOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_VarHandleOptions, 2)

static const flatbuffers_voffset_t __tflite_ReadVariableOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_ReadVariableOptions_ref_t;
static tflite_ReadVariableOptions_ref_t tflite_ReadVariableOptions_clone(flatbuffers_builder_t *B, tflite_ReadVariableOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_ReadVariableOptions, 0)

static const flatbuffers_voffset_t __tflite_AssignVariableOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_AssignVariableOptions_ref_t;
static tflite_AssignVariableOptions_ref_t tflite_AssignVariableOptions_clone(flatbuffers_builder_t *B, tflite_AssignVariableOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_AssignVariableOptions, 0)

static const flatbuffers_voffset_t __tflite_RandomOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_RandomOptions_ref_t;
static tflite_RandomOptions_ref_t tflite_RandomOptions_clone(flatbuffers_builder_t *B, tflite_RandomOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_RandomOptions, 2)

static const flatbuffers_voffset_t __tflite_BucketizeOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_BucketizeOptions_ref_t;
static tflite_BucketizeOptions_ref_t tflite_BucketizeOptions_clone(flatbuffers_builder_t *B, tflite_BucketizeOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_BucketizeOptions, 1)

static const flatbuffers_voffset_t __tflite_GeluOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_GeluOptions_ref_t;
static tflite_GeluOptions_ref_t tflite_GeluOptions_clone(flatbuffers_builder_t *B, tflite_GeluOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_GeluOptions, 1)

static const flatbuffers_voffset_t __tflite_DynamicUpdateSliceOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_DynamicUpdateSliceOptions_ref_t;
static tflite_DynamicUpdateSliceOptions_ref_t tflite_DynamicUpdateSliceOptions_clone(flatbuffers_builder_t *B, tflite_DynamicUpdateSliceOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_DynamicUpdateSliceOptions, 0)

static const flatbuffers_voffset_t __tflite_UnsortedSegmentProdOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_UnsortedSegmentProdOptions_ref_t;
static tflite_UnsortedSegmentProdOptions_ref_t tflite_UnsortedSegmentProdOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentProdOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_UnsortedSegmentProdOptions, 0)

static const flatbuffers_voffset_t __tflite_UnsortedSegmentMaxOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_UnsortedSegmentMaxOptions_ref_t;
static tflite_UnsortedSegmentMaxOptions_ref_t tflite_UnsortedSegmentMaxOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentMaxOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_UnsortedSegmentMaxOptions, 0)

static const flatbuffers_voffset_t __tflite_UnsortedSegmentSumOptions_required[] = { 0 };
typedef flatbuffers_ref_t tflite_UnsortedSegmentSumOptions_ref_t;
static tflite_UnsortedSegmentSumOptions_ref_t tflite_UnsortedSegmentSumOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentSumOptions_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_UnsortedSegmentSumOptions, 0)

static const flatbuffers_voffset_t __tflite_ATan2Options_required[] = { 0 };
typedef flatbuffers_ref_t tflite_ATan2Options_ref_t;
static tflite_ATan2Options_ref_t tflite_ATan2Options_clone(flatbuffers_builder_t *B, tflite_ATan2Options_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_ATan2Options, 0)
...
__flatbuffers_build_table(flatbuffers_, tflite_OperatorCode, 4)
...
static const flatbuffers_voffset_t __tflite_TensorMap_required[] = { 0 };
typedef flatbuffers_ref_t tflite_TensorMap_ref_t;
static tflite_TensorMap_ref_t tflite_TensorMap_clone(flatbuffers_builder_t *B, tflite_TensorMap_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_TensorMap, 2)

static const flatbuffers_voffset_t __tflite_SignatureDef_required[] = { 0 };
typedef flatbuffers_ref_t tflite_SignatureDef_ref_t;
static tflite_SignatureDef_ref_t tflite_SignatureDef_clone(flatbuffers_builder_t *B, tflite_SignatureDef_table_t t);
__flatbuffers_build_table(flatbuffers_, tflite_SignatureDef, 5)
...
__flatbuffers_build_table(flatbuffers_, tflite_Model, 8)
...
#define __tflite_Tensor_formal_args ,\
  ...
  tflite_QuantizationParameters_ref_t v4, flatbuffers_bool_t v5, tflite_SparsityParameters_ref_t v6, flatbuffers_int32_vec_ref_t v7, flatbuffers_bool_t v8
...
#define __tflite_Conv3DOptions_formal_args ,\
  tflite_Padding_enum_t v0, int32_t v1, int32_t v2, int32_t v3,\
  tflite_ActivationFunctionType_enum_t v4, int32_t v5, int32_t v6, int32_t v7
#define __tflite_Conv3DOptions_call_args ,\
  v0, v1, v2, v3,\
  v4, v5, v6, v7
static inline tflite_Conv3DOptions_ref_t tflite_Conv3DOptions_create(flatbuffers_builder_t *B __tflite_Conv3DOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_Conv3DOptions, tflite_Conv3DOptions_file_identifier, tflite_Conv3DOptions_type_identifier)
...
#define __tflite_SVDFOptions_formal_args , int32_t v0, tflite_ActivationFunctionType_enum_t v1, flatbuffers_bool_t v2
#define __tflite_SVDFOptions_call_args , v0, v1, v2
...
#define __tflite_RNNOptions_formal_args , tflite_ActivationFunctionType_enum_t v0, flatbuffers_bool_t v1
#define __tflite_RNNOptions_call_args , v0, v1
...
#define __tflite_SequenceRNNOptions_formal_args , flatbuffers_bool_t v0, tflite_ActivationFunctionType_enum_t v1, flatbuffers_bool_t v2
#define __tflite_SequenceRNNOptions_call_args , v0, v1, v2
...
#define __tflite_BidirectionalSequenceRNNOptions_formal_args , flatbuffers_bool_t v0, tflite_ActivationFunctionType_enum_t v1, flatbuffers_bool_t v2, flatbuffers_bool_t v3
#define __tflite_BidirectionalSequenceRNNOptions_call_args , v0, v1, v2, v3
...
#define __tflite_FullyConnectedOptions_formal_args , tflite_ActivationFunctionType_enum_t v0, tflite_FullyConnectedOptionsWeightsFormat_enum_t v1, flatbuffers_bool_t v2, flatbuffers_bool_t v3
#define __tflite_FullyConnectedOptions_call_args , v0, v1, v2, v3
...
#define __tflite_AddOptions_formal_args , tflite_ActivationFunctionType_enum_t v0, flatbuffers_bool_t v1
#define __tflite_AddOptions_call_args , v0, v1
...
#define __tflite_LSTMOptions_formal_args ,\
  tflite_ActivationFunctionType_enum_t v0, float v1, float v2, tflite_LSTMKernelType_enum_t v3, flatbuffers_bool_t v4
#define __tflite_LSTMOptions_call_args ,\
  v0, v1, v2, v3, v4
...
#define __tflite_UnidirectionalSequenceLSTMOptions_formal_args ,\
  tflite_ActivationFunctionType_enum_t v0, float v1, float v2, flatbuffers_bool_t v3, flatbuffers_bool_t v4
#define __tflite_UnidirectionalSequenceLSTMOptions_call_args ,\
  v0, v1, v2, v3, v4
...
#define __tflite_BidirectionalSequenceLSTMOptions_formal_args ,\
  tflite_ActivationFunctionType_enum_t v0, float v1, float v2, flatbuffers_bool_t v3, flatbuffers_bool_t v4, flatbuffers_bool_t v5
...
#define __tflite_ResizeNearestNeighborOptions_formal_args , flatbuffers_bool_t v0, flatbuffers_bool_t v1
#define __tflite_ResizeNearestNeighborOptions_call_args , v0, v1
...
#define __tflite_SubOptions_formal_args , tflite_ActivationFunctionType_enum_t v0, flatbuffers_bool_t v1
#define __tflite_SubOptions_call_args , v0, v1
...
#define __tflite_GatherOptions_formal_args , int32_t v0, int32_t v1
#define __tflite_GatherOptions_call_args , v0, v1
...
#define __tflite_CallOnceOptions_formal_args , int32_t v0
#define __tflite_CallOnceOptions_call_args , v0
static inline tflite_CallOnceOptions_ref_t tflite_CallOnceOptions_create(flatbuffers_builder_t *B __tflite_CallOnceOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_CallOnceOptions, tflite_CallOnceOptions_file_identifier, tflite_CallOnceOptions_type_identifier)
...
#define __tflite_BatchMatMulOptions_formal_args , flatbuffers_bool_t v0, flatbuffers_bool_t v1, flatbuffers_bool_t v2
#define __tflite_BatchMatMulOptions_call_args , v0, v1, v2
static inline tflite_BatchMatMulOptions_ref_t tflite_BatchMatMulOptions_create(flatbuffers_builder_t *B __tflite_BatchMatMulOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_BatchMatMulOptions, tflite_BatchMatMulOptions_file_identifier, tflite_BatchMatMulOptions_type_identifier)

#define __tflite_CumsumOptions_formal_args , flatbuffers_bool_t v0, flatbuffers_bool_t v1
#define __tflite_CumsumOptions_call_args , v0, v1
static inline tflite_CumsumOptions_ref_t tflite_CumsumOptions_create(flatbuffers_builder_t *B __tflite_CumsumOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_CumsumOptions, tflite_CumsumOptions_file_identifier, tflite_CumsumOptions_type_identifier)

#define __tflite_BroadcastToOptions_formal_args 
#define __tflite_BroadcastToOptions_call_args 
static inline tflite_BroadcastToOptions_ref_t tflite_BroadcastToOptions_create(flatbuffers_builder_t *B __tflite_BroadcastToOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_BroadcastToOptions, tflite_BroadcastToOptions_file_identifier, tflite_BroadcastToOptions_type_identifier)

#define __tflite_Rfft2dOptions_formal_args 
#define __tflite_Rfft2dOptions_call_args 
static inline tflite_Rfft2dOptions_ref_t tflite_Rfft2dOptions_create(flatbuffers_builder_t *B __tflite_Rfft2dOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_Rfft2dOptions, tflite_Rfft2dOptions_file_identifier, tflite_Rfft2dOptions_type_identifier)

#define __tflite_HashtableOptions_formal_args , int32_t v0, tflite_TensorType_enum_t v1, tflite_TensorType_enum_t v2
#define __tflite_HashtableOptions_call_args , v0, v1, v2
static inline tflite_HashtableOptions_ref_t tflite_HashtableOptions_create(flatbuffers_builder_t *B __tflite_HashtableOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_HashtableOptions, tflite_HashtableOptions_file_identifier, tflite_HashtableOptions_type_identifier)

#define __tflite_HashtableFindOptions_formal_args 
#define __tflite_HashtableFindOptions_call_args 
static inline tflite_HashtableFindOptions_ref_t tflite_HashtableFindOptions_create(flatbuffers_builder_t *B __tflite_HashtableFindOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_HashtableFindOptions, tflite_HashtableFindOptions_file_identifier, tflite_HashtableFindOptions_type_identifier)

#define __tflite_HashtableImportOptions_formal_args 
#define __tflite_HashtableImportOptions_call_args 
static inline tflite_HashtableImportOptions_ref_t tflite_HashtableImportOptions_create(flatbuffers_builder_t *B __tflite_HashtableImportOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_HashtableImportOptions, tflite_HashtableImportOptions_file_identifier, tflite_HashtableImportOptions_type_identifier)

#define __tflite_HashtableSizeOptions_formal_args 
#define __tflite_HashtableSizeOptions_call_args 
static inline tflite_HashtableSizeOptions_ref_t tflite_HashtableSizeOptions_create(flatbuffers_builder_t *B __tflite_HashtableSizeOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_HashtableSizeOptions, tflite_HashtableSizeOptions_file_identifier, tflite_HashtableSizeOptions_type_identifier)

#define __tflite_VarHandleOptions_formal_args , flatbuffers_string_ref_t v0, flatbuffers_string_ref_t v1
#define __tflite_VarHandleOptions_call_args , v0, v1
static inline tflite_VarHandleOptions_ref_t tflite_VarHandleOptions_create(flatbuffers_builder_t *B __tflite_VarHandleOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_VarHandleOptions, tflite_VarHandleOptions_file_identifier, tflite_VarHandleOptions_type_identifier)

#define __tflite_ReadVariableOptions_formal_args 
#define __tflite_ReadVariableOptions_call_args 
static inline tflite_ReadVariableOptions_ref_t tflite_ReadVariableOptions_create(flatbuffers_builder_t *B __tflite_ReadVariableOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_ReadVariableOptions, tflite_ReadVariableOptions_file_identifier, tflite_ReadVariableOptions_type_identifier)

#define __tflite_AssignVariableOptions_formal_args 
#define __tflite_AssignVariableOptions_call_args 
static inline tflite_AssignVariableOptions_ref_t tflite_AssignVariableOptions_create(flatbuffers_builder_t *B __tflite_AssignVariableOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_AssignVariableOptions, tflite_AssignVariableOptions_file_identifier, tflite_AssignVariableOptions_type_identifier)

#define __tflite_RandomOptions_formal_args , int64_t v0, int64_t v1
#define __tflite_RandomOptions_call_args , v0, v1
static inline tflite_RandomOptions_ref_t tflite_RandomOptions_create(flatbuffers_builder_t *B __tflite_RandomOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_RandomOptions, tflite_RandomOptions_file_identifier, tflite_RandomOptions_type_identifier)

#define __tflite_BucketizeOptions_formal_args , flatbuffers_float_vec_ref_t v0
#define __tflite_BucketizeOptions_call_args , v0
static inline tflite_BucketizeOptions_ref_t tflite_BucketizeOptions_create(flatbuffers_builder_t *B __tflite_BucketizeOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_BucketizeOptions, tflite_BucketizeOptions_file_identifier, tflite_BucketizeOptions_type_identifier)

#define __tflite_GeluOptions_formal_args , flatbuffers_bool_t v0
#define __tflite_GeluOptions_call_args , v0
static inline tflite_GeluOptions_ref_t tflite_GeluOptions_create(flatbuffers_builder_t *B __tflite_GeluOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_GeluOptions, tflite_GeluOptions_file_identifier, tflite_GeluOptions_type_identifier)

#define __tflite_DynamicUpdateSliceOptions_formal_args 
#define __tflite_DynamicUpdateSliceOptions_call_args 
static inline tflite_DynamicUpdateSliceOptions_ref_t tflite_DynamicUpdateSliceOptions_create(flatbuffers_builder_t *B __tflite_DynamicUpdateSliceOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_DynamicUpdateSliceOptions, tflite_DynamicUpdateSliceOptions_file_identifier, tflite_DynamicUpdateSliceOptions_type_identifier)

#define __tflite_UnsortedSegmentProdOptions_formal_args 
#define __tflite_UnsortedSegmentProdOptions_call_args 
static inline tflite_UnsortedSegmentProdOptions_ref_t tflite_UnsortedSegmentProdOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentProdOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_UnsortedSegmentProdOptions, tflite_UnsortedSegmentProdOptions_file_identifier, tflite_UnsortedSegmentProdOptions_type_identifier)

#define __tflite_UnsortedSegmentMaxOptions_formal_args 
#define __tflite_UnsortedSegmentMaxOptions_call_args 
static inline tflite_UnsortedSegmentMaxOptions_ref_t tflite_UnsortedSegmentMaxOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentMaxOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_UnsortedSegmentMaxOptions, tflite_UnsortedSegmentMaxOptions_file_identifier, tflite_UnsortedSegmentMaxOptions_type_identifier)

#define __tflite_UnsortedSegmentSumOptions_formal_args 
#define __tflite_UnsortedSegmentSumOptions_call_args 
static inline tflite_UnsortedSegmentSumOptions_ref_t tflite_UnsortedSegmentSumOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentSumOptions_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_UnsortedSegmentSumOptions, tflite_UnsortedSegmentSumOptions_file_identifier, tflite_UnsortedSegmentSumOptions_type_identifier)

#define __tflite_ATan2Options_formal_args 
#define __tflite_ATan2Options_call_args 
static inline tflite_ATan2Options_ref_t tflite_ATan2Options_create(flatbuffers_builder_t *B __tflite_ATan2Options_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_ATan2Options, tflite_ATan2Options_file_identifier, tflite_ATan2Options_type_identifier)

#define __tflite_OperatorCode_formal_args , int8_t v0, flatbuffers_string_ref_t v1, int32_t v2, tflite_BuiltinOperator_enum_t v3
#define __tflite_OperatorCode_call_args , v0, v1, v2, v3
...
#define __tflite_TensorMap_formal_args , flatbuffers_string_ref_t v0, uint32_t v1
#define __tflite_TensorMap_call_args , v0, v1
static inline tflite_TensorMap_ref_t tflite_TensorMap_create(flatbuffers_builder_t *B __tflite_TensorMap_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_TensorMap, tflite_TensorMap_file_identifier, tflite_TensorMap_type_identifier)

#define __tflite_SignatureDef_formal_args , tflite_TensorMap_vec_ref_t v0, tflite_TensorMap_vec_ref_t v1, flatbuffers_string_ref_t v2, uint32_t v4
#define __tflite_SignatureDef_call_args , v0, v1, v2, v4
static inline tflite_SignatureDef_ref_t tflite_SignatureDef_create(flatbuffers_builder_t *B __tflite_SignatureDef_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, tflite_SignatureDef, tflite_SignatureDef_file_identifier, tflite_SignatureDef_type_identifier)
...
#define __tflite_Model_formal_args ,\
  ...
  tflite_Buffer_vec_ref_t v4, flatbuffers_int32_vec_ref_t v5, tflite_Metadata_vec_ref_t v6, tflite_SignatureDef_vec_ref_t v7
...
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_BatchMatMulOptions(tflite_BatchMatMulOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_BatchMatMulOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_CumsumOptions(tflite_CumsumOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_CumsumOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_CallOnceOptions(tflite_CallOnceOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_CallOnceOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_BroadcastToOptions(tflite_BroadcastToOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_BroadcastToOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_Rfft2dOptions(tflite_Rfft2dOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_Rfft2dOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_Conv3DOptions(tflite_Conv3DOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_Conv3DOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_HashtableOptions(tflite_HashtableOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_HashtableOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_HashtableFindOptions(tflite_HashtableFindOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_HashtableFindOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_HashtableImportOptions(tflite_HashtableImportOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_HashtableImportOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_HashtableSizeOptions(tflite_HashtableSizeOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_HashtableSizeOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_VarHandleOptions(tflite_VarHandleOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_VarHandleOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_ReadVariableOptions(tflite_ReadVariableOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_ReadVariableOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_AssignVariableOptions(tflite_AssignVariableOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_AssignVariableOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_RandomOptions(tflite_RandomOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_RandomOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_BucketizeOptions(tflite_BucketizeOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_BucketizeOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_GeluOptions(tflite_GeluOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_GeluOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_DynamicUpdateSliceOptions(tflite_DynamicUpdateSliceOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_DynamicUpdateSliceOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_UnsortedSegmentProdOptions(tflite_UnsortedSegmentProdOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_UnsortedSegmentProdOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_UnsortedSegmentMaxOptions(tflite_UnsortedSegmentMaxOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_UnsortedSegmentMaxOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_UnsortedSegmentSumOptions(tflite_UnsortedSegmentSumOptions_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_UnsortedSegmentSumOptions; uref.value = ref; return uref; }
static inline tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_as_ATan2Options(tflite_ATan2Options_ref_t ref)
{ tflite_BuiltinOptions_union_ref_t uref; uref.type = tflite_BuiltinOptions_ATan2Options; uref.value = ref; return uref; }
...
static tflite_BuiltinOptions_union_ref_t tflite_BuiltinOptions_clone(flatbuffers_builder_t *B, tflite_BuiltinOptions_union_t u)
{
    ...
    case 101: return tflite_BuiltinOptions_as_BatchMatMulOptions(tflite_BatchMatMulOptions_clone(B, (tflite_BatchMatMulOptions_table_t)u.value));
    case 102: return tflite_BuiltinOptions_as_CumsumOptions(tflite_CumsumOptions_clone(B, (tflite_CumsumOptions_table_t)u.value));
    case 103: return tflite_BuiltinOptions_as_CallOnceOptions(tflite_CallOnceOptions_clone(B, (tflite_CallOnceOptions_table_t)u.value));
    case 104: return tflite_BuiltinOptions_as_BroadcastToOptions(tflite_BroadcastToOptions_clone(B, (tflite_BroadcastToOptions_table_t)u.value));
    case 105: return tflite_BuiltinOptions_as_Rfft2dOptions(tflite_Rfft2dOptions_clone(B, (tflite_Rfft2dOptions_table_t)u.value));
    case 106: return tflite_BuiltinOptions_as_Conv3DOptions(tflite_Conv3DOptions_clone(B, (tflite_Conv3DOptions_table_t)u.value));
    case 107: return tflite_BuiltinOptions_as_HashtableOptions(tflite_HashtableOptions_clone(B, (tflite_HashtableOptions_table_t)u.value));
    case 108: return tflite_BuiltinOptions_as_HashtableFindOptions(tflite_HashtableFindOptions_clone(B, (tflite_HashtableFindOptions_table_t)u.value));
    case 109: return tflite_BuiltinOptions_as_HashtableImportOptions(tflite_HashtableImportOptions_clone(B, (tflite_HashtableImportOptions_table_t)u.value));
    case 110: return tflite_BuiltinOptions_as_HashtableSizeOptions(tflite_HashtableSizeOptions_clone(B, (tflite_HashtableSizeOptions_table_t)u.value));
    case 111: return tflite_BuiltinOptions_as_VarHandleOptions(tflite_VarHandleOptions_clone(B, (tflite_VarHandleOptions_table_t)u.value));
    case 112: return tflite_BuiltinOptions_as_ReadVariableOptions(tflite_ReadVariableOptions_clone(B, (tflite_ReadVariableOptions_table_t)u.value));
    case 113: return tflite_BuiltinOptions_as_AssignVariableOptions(tflite_AssignVariableOptions_clone(B, (tflite_AssignVariableOptions_table_t)u.value));
    case 114: return tflite_BuiltinOptions_as_RandomOptions(tflite_RandomOptions_clone(B, (tflite_RandomOptions_table_t)u.value));
    case 115: return tflite_BuiltinOptions_as_BucketizeOptions(tflite_BucketizeOptions_clone(B, (tflite_BucketizeOptions_table_t)u.value));
    case 116: return tflite_BuiltinOptions_as_GeluOptions(tflite_GeluOptions_clone(B, (tflite_GeluOptions_table_t)u.value));
    case 117: return tflite_BuiltinOptions_as_DynamicUpdateSliceOptions(tflite_DynamicUpdateSliceOptions_clone(B, (tflite_DynamicUpdateSliceOptions_table_t)u.value));
    case 118: return tflite_BuiltinOptions_as_UnsortedSegmentProdOptions(tflite_UnsortedSegmentProdOptions_clone(B, (tflite_UnsortedSegmentProdOptions_table_t)u.value));
    case 119: return tflite_BuiltinOptions_as_UnsortedSegmentMaxOptions(tflite_UnsortedSegmentMaxOptions_clone(B, (tflite_UnsortedSegmentMaxOptions_table_t)u.value));
    case 120: return tflite_BuiltinOptions_as_UnsortedSegmentSumOptions(tflite_UnsortedSegmentSumOptions_clone(B, (tflite_UnsortedSegmentSumOptions_table_t)u.value));
    case 121: return tflite_BuiltinOptions_as_ATan2Options(tflite_ATan2Options_clone(B, (tflite_ATan2Options_table_t)u.value));
...
__flatbuffers_build_scalar_field(8, flatbuffers_, tflite_Tensor_has_rank, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_Tensor)
...
static inline tflite_Tensor_ref_t tflite_Tensor_create(flatbuffers_builder_t *B __tflite_Tensor_formal_args)
{
    if (tflite_Tensor_start(B)
        ...
        || tflite_Tensor_has_rank_add(B, v8)) {
        return 0;
    }
...
static tflite_Tensor_ref_t tflite_Tensor_clone(flatbuffers_builder_t *B, tflite_Tensor_table_t t)
{
    ...
    if (tflite_Tensor_start(B)
        ...
        || tflite_Tensor_has_rank_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_Conv3DOptions_padding, tflite_Padding, tflite_Padding_enum_t, 1, 1, INT8_C(0), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_Conv3DOptions_stride_d, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(2, flatbuffers_, tflite_Conv3DOptions_stride_w, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(3, flatbuffers_, tflite_Conv3DOptions_stride_h, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(4, flatbuffers_, tflite_Conv3DOptions_fused_activation_function, tflite_ActivationFunctionType, tflite_ActivationFunctionType_enum_t, 1, 1, INT8_C(0), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(5, flatbuffers_, tflite_Conv3DOptions_dilation_d_factor, flatbuffers_int32, int32_t, 4, 4, INT32_C(1), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(6, flatbuffers_, tflite_Conv3DOptions_dilation_w_factor, flatbuffers_int32, int32_t, 4, 4, INT32_C(1), tflite_Conv3DOptions)
__flatbuffers_build_scalar_field(7, flatbuffers_, tflite_Conv3DOptions_dilation_h_factor, flatbuffers_int32, int32_t, 4, 4, INT32_C(1), tflite_Conv3DOptions)

static inline tflite_Conv3DOptions_ref_t tflite_Conv3DOptions_create(flatbuffers_builder_t *B __tflite_Conv3DOptions_formal_args)
{
    if (tflite_Conv3DOptions_start(B)
        || tflite_Conv3DOptions_stride_d_add(B, v1)
        || tflite_Conv3DOptions_stride_w_add(B, v2)
        || tflite_Conv3DOptions_stride_h_add(B, v3)
        || tflite_Conv3DOptions_dilation_d_factor_add(B, v5)
        || tflite_Conv3DOptions_dilation_w_factor_add(B, v6)
        || tflite_Conv3DOptions_dilation_h_factor_add(B, v7)
        || tflite_Conv3DOptions_padding_add(B, v0)
        || tflite_Conv3DOptions_fused_activation_function_add(B, v4)) {
        return 0;
    }
    return tflite_Conv3DOptions_end(B);
}
...
static tflite_Conv3DOptions_ref_t tflite_Conv3DOptions_clone(flatbuffers_builder_t *B, tflite_Conv3DOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_Conv3DOptions_start(B)
        || tflite_Conv3DOptions_stride_d_pick(B, t)
        || tflite_Conv3DOptions_stride_w_pick(B, t)
        || tflite_Conv3DOptions_stride_h_pick(B, t)
        || tflite_Conv3DOptions_dilation_d_factor_pick(B, t)
        || tflite_Conv3DOptions_dilation_w_factor_pick(B, t)
        || tflite_Conv3DOptions_dilation_h_factor_pick(B, t)
        || tflite_Conv3DOptions_padding_pick(B, t)
        || tflite_Conv3DOptions_fused_activation_function_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_Conv3DOptions_end(B));
}
...
__flatbuffers_build_scalar_field(2, flatbuffers_, tflite_SVDFOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_SVDFOptions)
...
static inline tflite_SVDFOptions_ref_t tflite_SVDFOptions_create(flatbuffers_builder_t *B __tflite_SVDFOptions_formal_args)
{
    if (tflite_SVDFOptions_start(B)
        ...
        || tflite_SVDFOptions_asymmetric_quantize_inputs_add(B, v2)) {
        return 0;
    }
...
static tflite_SVDFOptions_ref_t tflite_SVDFOptions_clone(flatbuffers_builder_t *B, tflite_SVDFOptions_table_t t)
{
    ...
    if (tflite_SVDFOptions_start(B)
        ...
        || tflite_SVDFOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_RNNOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_RNNOptions)

static inline tflite_RNNOptions_ref_t tflite_RNNOptions_create(flatbuffers_builder_t *B __tflite_RNNOptions_formal_args)
{
    if (tflite_RNNOptions_start(B)
        || tflite_RNNOptions_fused_activation_function_add(B, v0)
        || tflite_RNNOptions_asymmetric_quantize_inputs_add(B, v1)) {
        return 0;
    }
...
static tflite_RNNOptions_ref_t tflite_RNNOptions_clone(flatbuffers_builder_t *B, tflite_RNNOptions_table_t t)
{
    ...
    if (tflite_RNNOptions_start(B)
        ...
        || tflite_RNNOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(2, flatbuffers_, tflite_SequenceRNNOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_SequenceRNNOptions)
...
static inline tflite_SequenceRNNOptions_ref_t tflite_SequenceRNNOptions_create(flatbuffers_builder_t *B __tflite_SequenceRNNOptions_formal_args)
{
    if (tflite_SequenceRNNOptions_start(B)
        ...
        || tflite_SequenceRNNOptions_asymmetric_quantize_inputs_add(B, v2)) {
        return 0;
    }
...
static tflite_SequenceRNNOptions_ref_t tflite_SequenceRNNOptions_clone(flatbuffers_builder_t *B, tflite_SequenceRNNOptions_table_t t)
{
    ...
    if (tflite_SequenceRNNOptions_start(B)
        ...
        || tflite_SequenceRNNOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(3, flatbuffers_, tflite_BidirectionalSequenceRNNOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_BidirectionalSequenceRNNOptions)
...
static inline tflite_BidirectionalSequenceRNNOptions_ref_t tflite_BidirectionalSequenceRNNOptions_create(flatbuffers_builder_t *B __tflite_BidirectionalSequenceRNNOptions_formal_args)
{
    if (tflite_BidirectionalSequenceRNNOptions_start(B)
        ...
        || tflite_BidirectionalSequenceRNNOptions_asymmetric_quantize_inputs_add(B, v3)) {
        return 0;
    }
...
static tflite_BidirectionalSequenceRNNOptions_ref_t tflite_BidirectionalSequenceRNNOptions_clone(flatbuffers_builder_t *B, tflite_BidirectionalSequenceRNNOptions_table_t t)
{
    ...
    if (tflite_BidirectionalSequenceRNNOptions_start(B)
        ...
        || tflite_BidirectionalSequenceRNNOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(3, flatbuffers_, tflite_FullyConnectedOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_FullyConnectedOptions)
...
static inline tflite_FullyConnectedOptions_ref_t tflite_FullyConnectedOptions_create(flatbuffers_builder_t *B __tflite_FullyConnectedOptions_formal_args)
{
    if (tflite_FullyConnectedOptions_start(B)
        ...
        || tflite_FullyConnectedOptions_asymmetric_quantize_inputs_add(B, v3)) {
        return 0;
    }
...
static tflite_FullyConnectedOptions_ref_t tflite_FullyConnectedOptions_clone(flatbuffers_builder_t *B, tflite_FullyConnectedOptions_table_t t)
{
    ...
    if (tflite_FullyConnectedOptions_start(B)
        ...
        || tflite_FullyConnectedOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_AddOptions_pot_scale_int16, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(1), tflite_AddOptions)

static inline tflite_AddOptions_ref_t tflite_AddOptions_create(flatbuffers_builder_t *B __tflite_AddOptions_formal_args)
{
    if (tflite_AddOptions_start(B)
        || tflite_AddOptions_fused_activation_function_add(B, v0)
        || tflite_AddOptions_pot_scale_int16_add(B, v1)) {
        return 0;
    }
...
static tflite_AddOptions_ref_t tflite_AddOptions_clone(flatbuffers_builder_t *B, tflite_AddOptions_table_t t)
{
    ...
    if (tflite_AddOptions_start(B)
        ...
        || tflite_AddOptions_pot_scale_int16_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(4, flatbuffers_, tflite_LSTMOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_LSTMOptions)
...
static inline tflite_LSTMOptions_ref_t tflite_LSTMOptions_create(flatbuffers_builder_t *B __tflite_LSTMOptions_formal_args)
{
    if (tflite_LSTMOptions_start(B)
        ...
        || tflite_LSTMOptions_asymmetric_quantize_inputs_add(B, v4)) {
        return 0;
    }
...
static tflite_LSTMOptions_ref_t tflite_LSTMOptions_clone(flatbuffers_builder_t *B, tflite_LSTMOptions_table_t t)
{
    ...
    if (tflite_LSTMOptions_start(B)
        ...
        || tflite_LSTMOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(4, flatbuffers_, tflite_UnidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_UnidirectionalSequenceLSTMOptions)
...
static inline tflite_UnidirectionalSequenceLSTMOptions_ref_t tflite_UnidirectionalSequenceLSTMOptions_create(flatbuffers_builder_t *B __tflite_UnidirectionalSequenceLSTMOptions_formal_args)
{
    if (tflite_UnidirectionalSequenceLSTMOptions_start(B)
        ...
        || tflite_UnidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs_add(B, v4)) {
        return 0;
    }
...
static tflite_UnidirectionalSequenceLSTMOptions_ref_t tflite_UnidirectionalSequenceLSTMOptions_clone(flatbuffers_builder_t *B, tflite_UnidirectionalSequenceLSTMOptions_table_t t)
{
    ...
    if (tflite_UnidirectionalSequenceLSTMOptions_start(B)
        ...
        || tflite_UnidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(5, flatbuffers_, tflite_BidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_BidirectionalSequenceLSTMOptions)
...
static inline tflite_BidirectionalSequenceLSTMOptions_ref_t tflite_BidirectionalSequenceLSTMOptions_create(flatbuffers_builder_t *B __tflite_BidirectionalSequenceLSTMOptions_formal_args)
{
    if (tflite_BidirectionalSequenceLSTMOptions_start(B)
        ...
        || tflite_BidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs_add(B, v5)) {
        return 0;
    }
...
static tflite_BidirectionalSequenceLSTMOptions_ref_t tflite_BidirectionalSequenceLSTMOptions_clone(flatbuffers_builder_t *B, tflite_BidirectionalSequenceLSTMOptions_table_t t)
{
    ...
    if (tflite_BidirectionalSequenceLSTMOptions_start(B)
        ...
        || tflite_BidirectionalSequenceLSTMOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_ResizeNearestNeighborOptions_half_pixel_centers, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_ResizeNearestNeighborOptions)

static inline tflite_ResizeNearestNeighborOptions_ref_t tflite_ResizeNearestNeighborOptions_create(flatbuffers_builder_t *B __tflite_ResizeNearestNeighborOptions_formal_args)
{
    if (tflite_ResizeNearestNeighborOptions_start(B)
        || tflite_ResizeNearestNeighborOptions_align_corners_add(B, v0)
        || tflite_ResizeNearestNeighborOptions_half_pixel_centers_add(B, v1)) {
        return 0;
    }
...
static tflite_ResizeNearestNeighborOptions_ref_t tflite_ResizeNearestNeighborOptions_clone(flatbuffers_builder_t *B, tflite_ResizeNearestNeighborOptions_table_t t)
{
    ...
    if (tflite_ResizeNearestNeighborOptions_start(B)
        ...
        || tflite_ResizeNearestNeighborOptions_half_pixel_centers_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_SubOptions_pot_scale_int16, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(1), tflite_SubOptions)

static inline tflite_SubOptions_ref_t tflite_SubOptions_create(flatbuffers_builder_t *B __tflite_SubOptions_formal_args)
{
    if (tflite_SubOptions_start(B)
        || tflite_SubOptions_fused_activation_function_add(B, v0)
        || tflite_SubOptions_pot_scale_int16_add(B, v1)) {
        return 0;
    }
...
static tflite_SubOptions_ref_t tflite_SubOptions_clone(flatbuffers_builder_t *B, tflite_SubOptions_table_t t)
{
    ...
    if (tflite_SubOptions_start(B)
        ...
        || tflite_SubOptions_pot_scale_int16_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_GatherOptions_batch_dims, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_GatherOptions)

static inline tflite_GatherOptions_ref_t tflite_GatherOptions_create(flatbuffers_builder_t *B __tflite_GatherOptions_formal_args)
{
    if (tflite_GatherOptions_start(B)
        || tflite_GatherOptions_axis_add(B, v0)
        || tflite_GatherOptions_batch_dims_add(B, v1)) {
        return 0;
    }
...
static tflite_GatherOptions_ref_t tflite_GatherOptions_clone(flatbuffers_builder_t *B, tflite_GatherOptions_table_t t)
{
    ...
    if (tflite_GatherOptions_start(B)
        ...
        || tflite_GatherOptions_batch_dims_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_CallOnceOptions_init_subgraph_index, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_CallOnceOptions)

static inline tflite_CallOnceOptions_ref_t tflite_CallOnceOptions_create(flatbuffers_builder_t *B __tflite_CallOnceOptions_formal_args)
{
    if (tflite_CallOnceOptions_start(B)
        || tflite_CallOnceOptions_init_subgraph_index_add(B, v0)) {
        return 0;
    }
    return tflite_CallOnceOptions_end(B);
}
...
static tflite_CallOnceOptions_ref_t tflite_CallOnceOptions_clone(flatbuffers_builder_t *B, tflite_CallOnceOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_CallOnceOptions_start(B)
        || tflite_CallOnceOptions_init_subgraph_index_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_CallOnceOptions_end(B));
}
...
__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_BatchMatMulOptions_adj_x, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_BatchMatMulOptions)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_BatchMatMulOptions_adj_y, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_BatchMatMulOptions)
__flatbuffers_build_scalar_field(2, flatbuffers_, tflite_BatchMatMulOptions_asymmetric_quantize_inputs, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_BatchMatMulOptions)

static inline tflite_BatchMatMulOptions_ref_t tflite_BatchMatMulOptions_create(flatbuffers_builder_t *B __tflite_BatchMatMulOptions_formal_args)
{
    if (tflite_BatchMatMulOptions_start(B)
        || tflite_BatchMatMulOptions_adj_x_add(B, v0)
        || tflite_BatchMatMulOptions_adj_y_add(B, v1)
        || tflite_BatchMatMulOptions_asymmetric_quantize_inputs_add(B, v2)) {
        return 0;
    }
    return tflite_BatchMatMulOptions_end(B);
}
...
static tflite_BatchMatMulOptions_ref_t tflite_BatchMatMulOptions_clone(flatbuffers_builder_t *B, tflite_BatchMatMulOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_BatchMatMulOptions_start(B)
        || tflite_BatchMatMulOptions_adj_x_pick(B, t)
        || tflite_BatchMatMulOptions_adj_y_pick(B, t)
        || tflite_BatchMatMulOptions_asymmetric_quantize_inputs_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_BatchMatMulOptions_end(B));
}

__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_CumsumOptions_exclusive, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_CumsumOptions)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_CumsumOptions_reverse, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_CumsumOptions)

static inline tflite_CumsumOptions_ref_t tflite_CumsumOptions_create(flatbuffers_builder_t *B __tflite_CumsumOptions_formal_args)
{
    if (tflite_CumsumOptions_start(B)
        || tflite_CumsumOptions_exclusive_add(B, v0)
        || tflite_CumsumOptions_reverse_add(B, v1)) {
        return 0;
    }
    return tflite_CumsumOptions_end(B);
}
...
static tflite_CumsumOptions_ref_t tflite_CumsumOptions_clone(flatbuffers_builder_t *B, tflite_CumsumOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_CumsumOptions_start(B)
        || tflite_CumsumOptions_exclusive_pick(B, t)
        || tflite_CumsumOptions_reverse_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_CumsumOptions_end(B));
}


static inline tflite_BroadcastToOptions_ref_t tflite_BroadcastToOptions_create(flatbuffers_builder_t *B __tflite_BroadcastToOptions_formal_args)
{
    if (tflite_BroadcastToOptions_start(B)) {
        return 0;
    }
    return tflite_BroadcastToOptions_end(B);
}
...
static tflite_BroadcastToOptions_ref_t tflite_BroadcastToOptions_clone(flatbuffers_builder_t *B, tflite_BroadcastToOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_BroadcastToOptions_end(B));
}


static inline tflite_Rfft2dOptions_ref_t tflite_Rfft2dOptions_create(flatbuffers_builder_t *B __tflite_Rfft2dOptions_formal_args)
{
    if (tflite_Rfft2dOptions_start(B)) {
        return 0;
    }
    return tflite_Rfft2dOptions_end(B);
}
...
static tflite_Rfft2dOptions_ref_t tflite_Rfft2dOptions_clone(flatbuffers_builder_t *B, tflite_Rfft2dOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_Rfft2dOptions_end(B));
}

__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_HashtableOptions_table_id, flatbuffers_int32, int32_t, 4, 4, INT32_C(0), tflite_HashtableOptions)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_HashtableOptions_key_dtype, tflite_TensorType, tflite_TensorType_enum_t, 1, 1, INT8_C(0), tflite_HashtableOptions)
__flatbuffers_build_scalar_field(2, flatbuffers_, tflite_HashtableOptions_value_dtype, tflite_TensorType, tflite_TensorType_enum_t, 1, 1, INT8_C(0), tflite_HashtableOptions)

static inline tflite_HashtableOptions_ref_t tflite_HashtableOptions_create(flatbuffers_builder_t *B __tflite_HashtableOptions_formal_args)
{
    if (tflite_HashtableOptions_start(B)
        || tflite_HashtableOptions_table_id_add(B, v0)
        || tflite_HashtableOptions_key_dtype_add(B, v1)
        || tflite_HashtableOptions_value_dtype_add(B, v2)) {
        return 0;
    }
    return tflite_HashtableOptions_end(B);
}
...
static tflite_HashtableOptions_ref_t tflite_HashtableOptions_clone(flatbuffers_builder_t *B, tflite_HashtableOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_HashtableOptions_start(B)
        || tflite_HashtableOptions_table_id_pick(B, t)
        || tflite_HashtableOptions_key_dtype_pick(B, t)
        || tflite_HashtableOptions_value_dtype_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_HashtableOptions_end(B));
}


static inline tflite_HashtableFindOptions_ref_t tflite_HashtableFindOptions_create(flatbuffers_builder_t *B __tflite_HashtableFindOptions_formal_args)
{
    if (tflite_HashtableFindOptions_start(B)) {
        return 0;
    }
    return tflite_HashtableFindOptions_end(B);
}
...
static tflite_HashtableFindOptions_ref_t tflite_HashtableFindOptions_clone(flatbuffers_builder_t *B, tflite_HashtableFindOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_HashtableFindOptions_end(B));
}


static inline tflite_HashtableImportOptions_ref_t tflite_HashtableImportOptions_create(flatbuffers_builder_t *B __tflite_HashtableImportOptions_formal_args)
{
    if (tflite_HashtableImportOptions_start(B)) {
        return 0;
    }
    return tflite_HashtableImportOptions_end(B);
}
...
static tflite_HashtableImportOptions_ref_t tflite_HashtableImportOptions_clone(flatbuffers_builder_t *B, tflite_HashtableImportOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_HashtableImportOptions_end(B));
}


static inline tflite_HashtableSizeOptions_ref_t tflite_HashtableSizeOptions_create(flatbuffers_builder_t *B __tflite_HashtableSizeOptions_formal_args)
{
    if (tflite_HashtableSizeOptions_start(B)) {
        return 0;
    }
    return tflite_HashtableSizeOptions_end(B);
}
...
static tflite_HashtableSizeOptions_ref_t tflite_HashtableSizeOptions_clone(flatbuffers_builder_t *B, tflite_HashtableSizeOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_HashtableSizeOptions_end(B));
}

__flatbuffers_build_string_field(0, flatbuffers_, tflite_VarHandleOptions_container, tflite_VarHandleOptions)
__flatbuffers_build_string_field(1, flatbuffers_, tflite_VarHandleOptions_shared_name, tflite_VarHandleOptions)

static inline tflite_VarHandleOptions_ref_t tflite_VarHandleOptions_create(flatbuffers_builder_t *B __tflite_VarHandleOptions_formal_args)
{
    if (tflite_VarHandleOptions_start(B)
        || tflite_VarHandleOptions_container_add(B, v0)
        || tflite_VarHandleOptions_shared_name_add(B, v1)) {
        return 0;
    }
    return tflite_VarHandleOptions_end(B);
}
...
static tflite_VarHandleOptions_ref_t tflite_VarHandleOptions_clone(flatbuffers_builder_t *B, tflite_VarHandleOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_VarHandleOptions_start(B)
        || tflite_VarHandleOptions_container_pick(B, t)
        || tflite_VarHandleOptions_shared_name_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_VarHandleOptions_end(B));
}


static inline tflite_ReadVariableOptions_ref_t tflite_ReadVariableOptions_create(flatbuffers_builder_t *B __tflite_ReadVariableOptions_formal_args)
{
    if (tflite_ReadVariableOptions_start(B)) {
        return 0;
    }
    return tflite_ReadVariableOptions_end(B);
}
...
static tflite_ReadVariableOptions_ref_t tflite_ReadVariableOptions_clone(flatbuffers_builder_t *B, tflite_ReadVariableOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_ReadVariableOptions_end(B));
}


static inline tflite_AssignVariableOptions_ref_t tflite_AssignVariableOptions_create(flatbuffers_builder_t *B __tflite_AssignVariableOptions_formal_args)
{
    if (tflite_AssignVariableOptions_start(B)) {
        return 0;
    }
    return tflite_AssignVariableOptions_end(B);
}
...
static tflite_AssignVariableOptions_ref_t tflite_AssignVariableOptions_clone(flatbuffers_builder_t *B, tflite_AssignVariableOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_AssignVariableOptions_end(B));
}

__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_RandomOptions_seed, flatbuffers_int64, int64_t, 8, 8, INT64_C(0), tflite_RandomOptions)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_RandomOptions_seed2, flatbuffers_int64, int64_t, 8, 8, INT64_C(0), tflite_RandomOptions)

static inline tflite_RandomOptions_ref_t tflite_RandomOptions_create(flatbuffers_builder_t *B __tflite_RandomOptions_formal_args)
{
    if (tflite_RandomOptions_start(B)
        || tflite_RandomOptions_seed_add(B, v0)
        || tflite_RandomOptions_seed2_add(B, v1)) {
        return 0;
    }
    return tflite_RandomOptions_end(B);
}
...
static tflite_RandomOptions_ref_t tflite_RandomOptions_clone(flatbuffers_builder_t *B, tflite_RandomOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_RandomOptions_start(B)
        || tflite_RandomOptions_seed_pick(B, t)
        || tflite_RandomOptions_seed2_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_RandomOptions_end(B));
}

__flatbuffers_build_vector_field(0, flatbuffers_, tflite_BucketizeOptions_boundaries, flatbuffers_float, float, tflite_BucketizeOptions)

static inline tflite_BucketizeOptions_ref_t tflite_BucketizeOptions_create(flatbuffers_builder_t *B __tflite_BucketizeOptions_formal_args)
{
    if (tflite_BucketizeOptions_start(B)
        || tflite_BucketizeOptions_boundaries_add(B, v0)) {
        return 0;
    }
    return tflite_BucketizeOptions_end(B);
}
...
static tflite_BucketizeOptions_ref_t tflite_BucketizeOptions_clone(flatbuffers_builder_t *B, tflite_BucketizeOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_BucketizeOptions_start(B)
        || tflite_BucketizeOptions_boundaries_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_BucketizeOptions_end(B));
}

__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_GeluOptions_approximate, flatbuffers_bool, flatbuffers_bool_t, 1, 1, UINT8_C(0), tflite_GeluOptions)

static inline tflite_GeluOptions_ref_t tflite_GeluOptions_create(flatbuffers_builder_t *B __tflite_GeluOptions_formal_args)
{
    if (tflite_GeluOptions_start(B)
        || tflite_GeluOptions_approximate_add(B, v0)) {
        return 0;
    }
    return tflite_GeluOptions_end(B);
}
...
static tflite_GeluOptions_ref_t tflite_GeluOptions_clone(flatbuffers_builder_t *B, tflite_GeluOptions_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_GeluOptions_start(B)
        || tflite_GeluOptions_approximate_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_GeluOptions_end(B));
}


static inline tflite_DynamicUpdateSliceOptions_ref_t tflite_DynamicUpdateSliceOptions_create(flatbuffers_builder_t *B __tflite_DynamicUpdateSliceOptions_formal_args)
{
    if (tflite_DynamicUpdateSliceOptions_start(B)) {
        return 0;
    }
    return tflite_DynamicUpdateSliceOptions_end(B);
}
...
static tflite_DynamicUpdateSliceOptions_ref_t tflite_DynamicUpdateSliceOptions_clone(flatbuffers_builder_t *B, tflite_DynamicUpdateSliceOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_DynamicUpdateSliceOptions_end(B));
}


static inline tflite_UnsortedSegmentProdOptions_ref_t tflite_UnsortedSegmentProdOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentProdOptions_formal_args)
{
    if (tflite_UnsortedSegmentProdOptions_start(B)) {
        return 0;
    }
    return tflite_UnsortedSegmentProdOptions_end(B);
}
...
static tflite_UnsortedSegmentProdOptions_ref_t tflite_UnsortedSegmentProdOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentProdOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_UnsortedSegmentProdOptions_end(B));
}


static inline tflite_UnsortedSegmentMaxOptions_ref_t tflite_UnsortedSegmentMaxOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentMaxOptions_formal_args)
{
    if (tflite_UnsortedSegmentMaxOptions_start(B)) {
        return 0;
    }
    return tflite_UnsortedSegmentMaxOptions_end(B);
}
...
static tflite_UnsortedSegmentMaxOptions_ref_t tflite_UnsortedSegmentMaxOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentMaxOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_UnsortedSegmentMaxOptions_end(B));
}


static inline tflite_UnsortedSegmentSumOptions_ref_t tflite_UnsortedSegmentSumOptions_create(flatbuffers_builder_t *B __tflite_UnsortedSegmentSumOptions_formal_args)
{
    if (tflite_UnsortedSegmentSumOptions_start(B)) {
        return 0;
    }
    return tflite_UnsortedSegmentSumOptions_end(B);
}
...
static tflite_UnsortedSegmentSumOptions_ref_t tflite_UnsortedSegmentSumOptions_clone(flatbuffers_builder_t *B, tflite_UnsortedSegmentSumOptions_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_UnsortedSegmentSumOptions_end(B));
}


static inline tflite_ATan2Options_ref_t tflite_ATan2Options_create(flatbuffers_builder_t *B __tflite_ATan2Options_formal_args)
{
    if (tflite_ATan2Options_start(B)) {
        return 0;
    }
    return tflite_ATan2Options_end(B);
}
...
static tflite_ATan2Options_ref_t tflite_ATan2Options_clone(flatbuffers_builder_t *B, tflite_ATan2Options_table_t t)
{
    ...
    __flatbuffers_memoize_end(B, t, tflite_ATan2Options_end(B));
}

__flatbuffers_build_scalar_field(0, flatbuffers_, tflite_OperatorCode_deprecated_builtin_code, flatbuffers_int8, int8_t, 1, 1, INT8_C(0), tflite_OperatorCode)
...
__flatbuffers_build_scalar_field(3, flatbuffers_, tflite_OperatorCode_builtin_code, tflite_BuiltinOperator, tflite_BuiltinOperator_enum_t, 4, 4, INT32_C(0), tflite_OperatorCode)
...
static inline tflite_OperatorCode_ref_t tflite_OperatorCode_create(flatbuffers_builder_t *B __tflite_OperatorCode_formal_args)
{
    if (tflite_OperatorCode_start(B)
        ...
        || tflite_OperatorCode_builtin_code_add(B, v3)
        || tflite_OperatorCode_deprecated_builtin_code_add(B, v0)) {
        return 0;
    }
...
static tflite_OperatorCode_ref_t tflite_OperatorCode_clone(flatbuffers_builder_t *B, tflite_OperatorCode_table_t t)
{
    ...
    if (tflite_OperatorCode_start(B)
        ...
        || tflite_OperatorCode_deprecated_builtin_code_pick(B, t)) {
        return 0;
    }
...
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, BatchMatMulOptions, tflite_BatchMatMulOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, CumsumOptions, tflite_CumsumOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, CallOnceOptions, tflite_CallOnceOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, BroadcastToOptions, tflite_BroadcastToOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, Rfft2dOptions, tflite_Rfft2dOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, Conv3DOptions, tflite_Conv3DOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, HashtableOptions, tflite_HashtableOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, HashtableFindOptions, tflite_HashtableFindOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, HashtableImportOptions, tflite_HashtableImportOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, HashtableSizeOptions, tflite_HashtableSizeOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, VarHandleOptions, tflite_VarHandleOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, ReadVariableOptions, tflite_ReadVariableOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, AssignVariableOptions, tflite_AssignVariableOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, RandomOptions, tflite_RandomOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, BucketizeOptions, tflite_BucketizeOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, GeluOptions, tflite_GeluOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, DynamicUpdateSliceOptions, tflite_DynamicUpdateSliceOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, UnsortedSegmentProdOptions, tflite_UnsortedSegmentProdOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, UnsortedSegmentMaxOptions, tflite_UnsortedSegmentMaxOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, UnsortedSegmentSumOptions, tflite_UnsortedSegmentSumOptions)
__flatbuffers_build_union_table_value_field(flatbuffers_, tflite_Operator_builtin_options, tflite_BuiltinOptions, ATan2Options, tflite_ATan2Options)
...
__flatbuffers_build_string_field(0, flatbuffers_, tflite_TensorMap_name, tflite_TensorMap)
__flatbuffers_build_scalar_field(1, flatbuffers_, tflite_TensorMap_tensor_index, flatbuffers_uint32, uint32_t, 4, 4, UINT32_C(0), tflite_TensorMap)

static inline tflite_TensorMap_ref_t tflite_TensorMap_create(flatbuffers_builder_t *B __tflite_TensorMap_formal_args)
{
    if (tflite_TensorMap_start(B)
        || tflite_TensorMap_name_add(B, v0)
        || tflite_TensorMap_tensor_index_add(B, v1)) {
        return 0;
    }
    return tflite_TensorMap_end(B);
}
...
static tflite_TensorMap_ref_t tflite_TensorMap_clone(flatbuffers_builder_t *B, tflite_TensorMap_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_TensorMap_start(B)
        || tflite_TensorMap_name_pick(B, t)
        || tflite_TensorMap_tensor_index_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_TensorMap_end(B));
}

__flatbuffers_build_table_vector_field(0, flatbuffers_, tflite_SignatureDef_inputs, tflite_TensorMap, tflite_SignatureDef)
__flatbuffers_build_table_vector_field(1, flatbuffers_, tflite_SignatureDef_outputs, tflite_TensorMap, tflite_SignatureDef)
__flatbuffers_build_string_field(2, flatbuffers_, tflite_SignatureDef_signature_key, tflite_SignatureDef)
/* Skipping build of deprecated field: 'tflite_SignatureDef_deprecated_tag' */

__flatbuffers_build_scalar_field(4, flatbuffers_, tflite_SignatureDef_subgraph_index, flatbuffers_uint32, uint32_t, 4, 4, UINT32_C(0), tflite_SignatureDef)

static inline tflite_SignatureDef_ref_t tflite_SignatureDef_create(flatbuffers_builder_t *B __tflite_SignatureDef_formal_args)
{
    if (tflite_SignatureDef_start(B)
        || tflite_SignatureDef_inputs_add(B, v0)
        || tflite_SignatureDef_outputs_add(B, v1)
        || tflite_SignatureDef_signature_key_add(B, v2)
        || tflite_SignatureDef_subgraph_index_add(B, v4)) {
        return 0;
    }
    return tflite_SignatureDef_end(B);
}
...
static tflite_SignatureDef_ref_t tflite_SignatureDef_clone(flatbuffers_builder_t *B, tflite_SignatureDef_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (tflite_SignatureDef_start(B)
        || tflite_SignatureDef_inputs_pick(B, t)
        || tflite_SignatureDef_outputs_pick(B, t)
        || tflite_SignatureDef_signature_key_pick(B, t)
        || tflite_SignatureDef_subgraph_index_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, tflite_SignatureDef_end(B));
}
...
__flatbuffers_build_table_vector_field(7, flatbuffers_, tflite_Model_signature_defs, tflite_SignatureDef, tflite_Model)
...
static inline tflite_Model_ref_t tflite_Model_create(flatbuffers_builder_t *B __tflite_Model_formal_args)
{
    if (tflite_Model_start(B)
        ...
        || tflite_Model_signature_defs_add(B, v7)) {
        return 0;
    }
...
static tflite_Model_ref_t tflite_Model_clone(flatbuffers_builder_t *B, tflite_Model_table_t t)
{
    ...
    if (tflite_Model_start(B)
        ...
        || tflite_Model_signature_defs_pick(B, t)) {
        return 0;
    }
