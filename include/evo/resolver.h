#ifndef __EVO_RESOLVER_H__
#define __EVO_RESOLVER_H__
...
void op_DequantizeLinear_dft(node_t*);
...
void op_PRelu_dft(node_t*);
void op_QuantizeLinear_dft(node_t*);
...
void op_Tri_dft(node_t*);

#ifdef __cplusplus
}
#endif  // __cplusplus

#endif  // __EVO_RESOLVER_H__